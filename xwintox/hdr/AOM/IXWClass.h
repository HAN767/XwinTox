...
template < typename T > class XWClassT
{
  public:
    XWClassT ()
    {
    ...
    int xwfDesubscribe (unsigned int dwType)
    {
        return hObj_->pSvcs->fnDesubscribe (hObj_, dwType, this, fnRecvSignal);
    }
    ...
    {
        return hObj_->pSvcs->fnRegisterFilter (hObj_, dwType, this,
                                               fnFilterSignal);
    }
