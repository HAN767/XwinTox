...
Sidebar_Top_Area::Sidebar_Top_Area(int S) : Fl_Group(XwinTox->basex * S,
	        XwinTox->basey * S, (XwinTox->sblength * S), 60 * S)
{
	scale =S;
...
Sidebar_Bottom_Area::Sidebar_Bottom_Area(int S) : Fl_Group(XwinTox->basex * S,
	        XwinTox->h() - (36 * S) - (XwinTox->basey * S), (XwinTox->sblength * S),
	                                   ...
	                                   XwinTox->h() - (XwinTox->basey * S))
{
	...
	contacts =new ContactsList(x(), y() + (60 * S),(XwinTox->sblength * S),
	                           h() - (36 * S) - (60 * S), S);
