    ...
    : Fl_Group (0, 0, 1, 1)
{
    ...
    avbox = new SVGBox (0, 0, 40 * scale, 40 * scale, S, default_av, 1);
    ...
    status->value (
        "XwinTox Frameworks 2"); // Dictionary_get(APP->Config, "Tox.Status"));
