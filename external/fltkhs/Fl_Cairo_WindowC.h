...
EXPORT
{
    ...
    /* FL_EXPORT_C(void,         Fl_Cairo_Window_forms_end)(fl_Cairo_Window
     * win); */
    /* Fl_Window inherited */
...
// flush resize destructor, constructor
    ...
    class Fl_DerivedCairo_Window : public Fl_Cairo_Window
    {
      ...
      public:
        ...
        int * sizes ();
        Fl_DerivedCairo_Window (int X, int Y, int W, int H, const char * l,
                                fl_Cairo_Window_Virtual_Funcs * funcs);
        Fl_DerivedCairo_Window (int X, int Y, int W, int H,
                                fl_Cairo_Window_Virtual_Funcs * funcs);
        Fl_DerivedCairo_Window (int W, int H, const char * l,
                                fl_Cairo_Window_Virtual_Funcs * funcs);
        Fl_DerivedCairo_Window (int W, int H,
                                fl_Cairo_Window_Virtual_Funcs * funcs);
