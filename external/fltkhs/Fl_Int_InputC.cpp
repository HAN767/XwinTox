...
#ifdef __cplusplus
Fl_DerivedInt_Input::Fl_DerivedInt_Input (int X, int Y, int W, int H,
                                          const char * l,
                                          fl_Int_Input_Virtual_Funcs * funcs)
...
void * Fl_DerivedInt_Input::get_other_data () { return this->other_data; }
void Fl_DerivedInt_Input::set_other_data (void * data)
{
    this->other_data = data;
}
void Fl_DerivedInt_Input::draw_box () { Fl_Int_Input::draw_box (); }
void Fl_DerivedInt_Input::draw_box (Fl_Boxtype t, Fl_Color c)
{
    Fl_Int_Input::draw_box (t, c);
}
void Fl_DerivedInt_Input::draw_box (Fl_Boxtype t, int x, int y, int w, int h,
                                    Fl_Color c)
{
    Fl_Int_Input::draw_box (t, x, y, w, h, c);
}
void Fl_DerivedInt_Input::draw_backdrop () { Fl_Int_Input::draw_backdrop (); }
void Fl_DerivedInt_Input::draw_focus () { Fl_Int_Input::draw_focus (); }
void Fl_DerivedInt_Input::draw_focus (Fl_Boxtype t, int x, int y, int w, int h)
{
    Fl_Int_Input::draw_focus (t, x, y, w, h);
}
void Fl_DerivedInt_Input::draw_label () { Fl_Int_Input::draw_label (); }
void Fl_DerivedInt_Input::draw_label (int x, int y, int w, int h,
                                      Fl_Align alignment)
{
...
Fl_Window * Fl_DerivedInt_Input::as_window ()
{
    ...
    if (this->overriddenFuncs->as_window != NULL)
    {
        win = (static_cast<Fl_Window *> (
            this->overriddenFuncs->as_window ((fl_Int_Input) this)));
    }
    else
    {
...
Fl_Gl_Window * Fl_DerivedInt_Input::as_gl_window ()
{
    ...
    if (this->overriddenFuncs->as_gl_window != NULL)
    {
        win = (static_cast<Fl_Gl_Window *> (
            this->overriddenFuncs->as_gl_window ((fl_Int_Input) this)));
    }
    else
    {
...
EXPORT
{
    ...
    {
        fl_Int_Input_Virtual_Funcs * ptr =
            (fl_Int_Input_Virtual_Funcs *)malloc (
                sizeof (fl_Int_Input_Virtual_Funcs));
        ptr->draw         = NULL;
        ptr->handle       = NULL;
        ptr->resize       = NULL;
        ptr->show         = NULL;
    ...
    {
        return (fl_Gl_Window) (static_cast<Fl_Int_Input *> (int_input))
            ->as_gl_window ();
    }
    FL_EXPORT_C(fl_Gl_Window,Fl_Int_Input_as_gl_window )(fl_Int_Input int_input)
    {
        return (fl_Gl_Window) (static_cast<Fl_DerivedInt_Input *> (int_input))
            ->as_gl_window ();
    }
    ...
    {
        return (fl_Group) (static_cast<Fl_DerivedInt_Input *> (int_input))
            ->parent ();
    }
    FL_EXPORT_C(void,Fl_Int_Input_set_parent)(fl_Int_Input int_input,fl_Group grp)
    {
        (static_cast<Fl_DerivedInt_Input *> (int_input))
    ...
    {
        return (static_cast<Fl_DerivedInt_Input *> (int_input))
            ->selection_color ();
    }
    ...
    FL_EXPORT_C(void,Fl_Int_Input_set_user_data)(fl_Int_Input int_input,void* v)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Int_Input *> (int_input))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (fl_Window) (static_cast<Fl_DerivedInt_Input *> (int_input))
            ->window ();
    }
    ...
    {
        fl_Int_Input_Virtual_Funcs * funcs =
            Fl_Int_Input_default_virtual_funcs ();
        Fl_DerivedInt_Input * int_input =
            new Fl_DerivedInt_Input (x, y, w, h, label, funcs);
    ...
    FL_EXPORT_C (fl_Int_Input, Fl_Int_Input_New) (int x, int y, int w, int h)
    {
        fl_Int_Input_Virtual_Funcs * funcs =
            Fl_Int_Input_default_virtual_funcs ();
        Fl_DerivedInt_Input * int_input =
            new Fl_DerivedInt_Input (x, y, w, h, 0, funcs);
        return (static_cast<fl_Int_Input> (int_input));
    }
