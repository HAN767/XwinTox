...
EXPORT
{
    ...
    {
        (static_cast<Fl_Counter *> (counter))
    ...
    FL_EXPORT_C (void *, Fl_Counter_user_data) (fl_Counter counter)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Counter *> (counter))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (static_cast<Fl_Counter *> (counter))
    ...
    {
        return (fl_Window) (static_cast<Fl_Counter *> (counter))
    ...
    FL_EXPORT_C(fl_Simple_Counter,Fl_Simple_Counter_New_WithLabel)(int x,int y,int w,int h,const char* label)
    {
        Fl_Simple_Counter * simple_counter =
            new Fl_Simple_Counter (x, y, w, h, label);
