...
EXPORT
{
    ...
    {
        (static_cast<Fl_Adjuster *> (adjuster))
    ...
    FL_EXPORT_C (void *, Fl_Adjuster_user_data) (fl_Adjuster adjuster)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Adjuster *> (adjuster))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (static_cast<Fl_Adjuster *> (adjuster))
    ...
    {
        return (fl_Window) (static_cast<Fl_Adjuster *> (adjuster))
