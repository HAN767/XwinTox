...
EXPORT
{
    ...
    FL_EXPORT_C (void *, Fl_Input__user_data) (fl_Input_ input_)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Input_ *> (input_))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (static_cast<Fl_Input_ *> (input_))
    ...
    {
        return (fl_Window) (static_cast<Fl_Input_ *> (input_))
    ...
    {
        return (fl_Gl_Window) (static_cast<Fl_Input_ *> (input_))
            ->as_gl_window ();
    }
