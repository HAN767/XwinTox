...
#ifdef __cplusplus
Fl_DerivedGl_Window::Fl_DerivedGl_Window (int X, int Y, int W, int H,
                                          const char * l,
                                          fl_Gl_Window_Virtual_Funcs * funcs)
...
Fl_DerivedGl_Window::Fl_DerivedGl_Window (int W, int H, const char * l,
                                          fl_Gl_Window_Virtual_Funcs * funcs)
    : Fl_Gl_Window (W, H, l)
{
    overriddenFuncs = funcs;
...
Fl_DerivedGl_Window::Fl_DerivedGl_Window (int W, int H,
                                          fl_Gl_Window_Virtual_Funcs * funcs)
    : Fl_Gl_Window (W, H, 0)
{
    overriddenFuncs = funcs;
...
void * Fl_DerivedGl_Window::get_other_data () { return this->other_data; }
...
void Fl_DerivedGl_Window::draw_box () { Fl_Gl_Window::draw_box (); }
void Fl_DerivedGl_Window::draw_box (Fl_Boxtype t, Fl_Color c)
{
    Fl_Gl_Window::draw_box (t, c);
}
void Fl_DerivedGl_Window::draw_box (Fl_Boxtype t, int x, int y, int w, int h,
                                    Fl_Color c)
{
    Fl_Gl_Window::draw_box (t, x, y, w, h, c);
}
void Fl_DerivedGl_Window::draw_backdrop () { Fl_Gl_Window::draw_backdrop (); }
void Fl_DerivedGl_Window::draw_focus () { Fl_Gl_Window::draw_focus (); }
void Fl_DerivedGl_Window::draw_focus (Fl_Boxtype t, int x, int y, int w, int h)
{
    Fl_Gl_Window::draw_focus (t, x, y, w, h);
}
void Fl_DerivedGl_Window::draw_label () { Fl_Gl_Window::draw_label (); }
void Fl_DerivedGl_Window::draw_label (int x, int y, int w, int h,
                                      Fl_Align alignment)
{
...
void Fl_DerivedGl_Window::flush_super () { Fl_Gl_Window::flush (); }
...
void Fl_DerivedGl_Window::show_super () { Fl_Gl_Window::show (); }
...
void Fl_DerivedGl_Window::hide_super () { Fl_Gl_Window::hide (); }
...
void Fl_DerivedGl_Window::draw_super () { Fl_Gl_Window::draw (); }
Fl_Group * Fl_DerivedGl_Window::as_group ()
{
    ...
    if (this->overriddenFuncs->as_gl_window != NULL)
    {
        grp = (static_cast<Fl_Group *> (
            this->overriddenFuncs->as_group ((fl_Gl_Window) this)));
    }
    else
    {
...
Fl_Window * Fl_DerivedGl_Window::as_window ()
{
    ...
    if (this->overriddenFuncs->as_gl_window != NULL)
    {
        win = (static_cast<Fl_Window *> (
            this->overriddenFuncs->as_window ((fl_Gl_Window) this)));
    }
    else
    {
...
Fl_Gl_Window * Fl_DerivedGl_Window::as_gl_window ()
{
    ...
    if (this->overriddenFuncs->as_gl_window != NULL)
    {
        win = (static_cast<Fl_Gl_Window *> (
            this->overriddenFuncs->as_gl_window ((fl_Gl_Window) this)));
    }
    else
    {
...
EXPORT
{
    ...
    {
        fl_Gl_Window_Virtual_Funcs * ptr =
            (fl_Gl_Window_Virtual_Funcs *)malloc (
                sizeof (fl_Gl_Window_Virtual_Funcs));
        ptr->draw         = NULL;
        ptr->handle       = NULL;
        ptr->resize       = NULL;
        ptr->show         = NULL;
    ...
    {
        return (static_cast<Fl_DerivedGl_Window *> (self))
    ...
    {
        (static_cast<Fl_DerivedGl_Window *> (win))
    ...
    {
        (static_cast<Fl_DerivedGl_Window *> (Gl_Window))
    ...
    {
        Fl_DerivedGl_Window * castedGl_Window =
            (static_cast<Fl_DerivedGl_Window *> (win));
    ...
    FL_EXPORT_C (void *, Fl_Gl_Window_user_data) (fl_Gl_Window win)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_DerivedGl_Window *> (win))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Gl_Window *> (win))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (static_cast<Fl_DerivedGl_Window *> (win))
    ...
    {
        return (fl_Group) (static_cast<Fl_DerivedGl_Window *> (win))
            ->as_group ();
    }
    ...
    {
        return (fl_Gl_Window) (static_cast<Fl_DerivedGl_Window *> (win))
            ->as_window ();
    }
    ...
    {
        return (fl_Gl_Window) (static_cast<Fl_DerivedGl_Window *> (gl_window))
            ->window ();
    }
    FL_EXPORT_C (fl_Window, Fl_Gl_Window_top_window) (fl_Gl_Window gl_window)
    {
        return (fl_Window) (static_cast<Fl_DerivedGl_Window *> (gl_window))
            ->top_window ();
    }
    ...
    {
        return (fl_Widget) (static_cast<Fl_DerivedGl_Window *> (win))
            ->resizable ();
    }
    ...
    {
        return (static_cast<Fl_DerivedGl_Window *> (gl_window))
            ->get_other_data ();
    }
    ...
    {
        fl_Gl_Window_Virtual_Funcs * funcs =
            Fl_Gl_Window_default_virtual_funcs ();
        Fl_DerivedGl_Window * gl_window =
            new Fl_DerivedGl_Window (w, h, title, funcs);
    ...
    FL_EXPORT_C (fl_Gl_Window, Fl_Gl_Window_New) (int w, int h)
    {
        fl_Gl_Window_Virtual_Funcs * funcs =
            Fl_Gl_Window_default_virtual_funcs ();
        Fl_DerivedGl_Window * gl_window =
            new Fl_DerivedGl_Window (w, h, 0, funcs);
    ...
    FL_EXPORT_C(fl_Gl_Window, Fl_Gl_Window_NewXY_WithLabel)(int x, int y, int w, int h, const char* title)
    {
        fl_Gl_Window_Virtual_Funcs * funcs =
            Fl_Gl_Window_default_virtual_funcs ();
        Fl_DerivedGl_Window * gl_window =
            new Fl_DerivedGl_Window (x, y, w, h, title, funcs);
        return (fl_Gl_Window)gl_window;
    }
    ...
    FL_EXPORT_C (fl_Gl_Window, Fl_Gl_Window_NewXY) (int x, int y, int w, int h)
    {
        fl_Gl_Window_Virtual_Funcs * funcs =
            Fl_Gl_Window_default_virtual_funcs ();
        Fl_DerivedGl_Window * gl_window =
            new Fl_DerivedGl_Window (x, y, w, h, 0, funcs);
        return (fl_Gl_Window)gl_window;
    }
    ...
    {
        (static_cast<Fl_DerivedGl_Window *> (win))
            ->hotspot ((static_cast<Fl_Widget *> (w)), 0);
    }
    ...
    {
        fl_Window_size_range_args * ptr = (fl_Window_size_range_args *)malloc (
            sizeof (fl_Window_size_range_args));
        ptr->maxw   = 0;
        ptr->maxh   = 0;
        ptr->dw     = 0;
        ptr->dh     = 0;
    ...
    {
        fl_Window_size_range_args * ptr =
            Fl_Gl_Window_default_size_range_args ();
        (static_cast<Fl_DerivedGl_Window *> (win))
    ...
    {
        (static_cast<Fl_DerivedGl_Window *> (win))
            ->cursor (cursor, FL_BLACK, FL_WHITE);
    }
    ...
    {
        Fl_Gl_Window::default_callback (
            (static_cast<Fl_DerivedGl_Window *> (win)), v);
    }
