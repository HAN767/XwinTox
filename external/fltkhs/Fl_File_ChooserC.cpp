...
EXPORT
{
    ...
    {
        (static_cast<Fl_File_Chooser *> (file_chooser))
    ...
    FL_EXPORT_C(void,Fl_File_Chooser_set_user_data)(fl_File_Chooser file_chooser, void* v)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_File_Chooser *> (file_chooser))->user_data ()));
        if (stored_cb)
        {
    ...
    FL_EXPORT_C(void*,Fl_File_Chooser_user_data)(fl_File_Chooser file_chooser)
    {
        ...
        {
            return (static_cast<Fl_File_Chooser *> (file_chooser))
                ->user_data ();
        }
    }
    ...
    {
        return (static_cast<Fl_File_Chooser *> (file_chooser))
            ->add_extra ((static_cast<Fl_Widget *> (gr)));
    }
