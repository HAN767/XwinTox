...
EXPORT
{
    ...
    {
        return (fl_Group) (static_cast<Fl_Value_Input *> (value_input))
            ->parent ();
    }
    FL_EXPORT_C(void,Fl_Value_Input_set_parent)(fl_Value_Input value_input,fl_Group grp)
    {
        (static_cast<Fl_Value_Input *> (value_input))
    ...
    FL_EXPORT_C (void *, Fl_Value_Input_user_data) (fl_Value_Input value_input)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Value_Input *> (value_input))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (fl_Window) (static_cast<Fl_Value_Input *> (value_input))
            ->window ();
    }
    ...
    {
        return (fl_Gl_Window) (static_cast<Fl_Value_Input *> (value_input))
            ->as_gl_window ();
    }
