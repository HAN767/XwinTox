...
class C_to_Fl_Label_Draw_F
{
  public:
    ...
    static void intercept (const Fl_Label * label, int x, int y, int w, int h,
                           Fl_Align align)
    {
...
EXPORT
{
    ...
    FL_EXPORT_C (double, Fl_version) () { return Fl::version (); }
    FL_EXPORT_C (const char *, Fl_help) () { return Fl::help; }
    ...
    FL_EXPORT_C (void, Fl_display) (const char * text) { Fl::display (text); }
    FL_EXPORT_C (int, Fl_visual) (int mode) { return Fl::visual (mode); }
#if !defined(__APPLE__) && !defined(__FreeBSD__)
    FL_EXPORT_C (int, Fl_gl_visual) (int mode) { return Fl::gl_visual (mode); }
    FL_EXPORT_C (int, Fl_gl_visual_with_alist) (int mode, int * alist)
    {
        return Fl::gl_visual (mode, alist);
    }
#endif
    FL_EXPORT_C (void, Fl_own_colormap) () { Fl::own_colormap (); }
    FL_EXPORT_C (void, Fl_get_system_colors) () { Fl::get_system_colors (); }
    ...
    FL_EXPORT_C (const char *, Fl_scheme) () { return Fl::scheme (); }
    FL_EXPORT_C (int, Fl_is_scheme) (const char * text)
    {
        return Fl::is_scheme (text);
    }
    FL_EXPORT_C (int, Fl_scrollbar_size) () { return Fl::scrollbar_size (); }
    FL_EXPORT_C (void, Fl_set_scrollbar_size) (int W)
    {
        Fl::scrollbar_size (W);
    }
    FL_EXPORT_C (int, Fl_wait) () { return Fl::wait (); }
    FL_EXPORT_C (double, Fl_set_wait) (double time) { return Fl::wait (time); }
    FL_EXPORT_C (int, Fl_option) (Fl_Option option)
    {
        Fl::Fl_Option o = (Fl::Fl_Option)-1;
        switch (option)
        {
        case OPTION_ARROW_FOCUS:
        {
            o = Fl::OPTION_ARROW_FOCUS;
            break;
        }
        case OPTION_VISIBLE_FOCUS:
        {
            o = Fl::OPTION_VISIBLE_FOCUS;
            break;
        }
        case OPTION_DND_TEXT:
        {
            o = Fl::OPTION_DND_TEXT;
            break;
        }
        case OPTION_SHOW_TOOLTIPS:
        {
            o = Fl::OPTION_SHOW_TOOLTIPS;
            break;
        }
        case OPTION_LAST:
        {
    ...
    FL_EXPORT_C (int, Fl_damage) () { return Fl::damage (); }
    FL_EXPORT_C (void, Fl_redraw) () { Fl::redraw (); }
    FL_EXPORT_C (void, Fl_flush) () { Fl::flush (); }
    FL_EXPORT_C (fl_Window, Fl_next_window) (fl_Window window)
    {
        return (fl_Window)Fl::next_window ((static_cast<Fl_Window *> (window)));
    }
    FL_EXPORT_C (fl_Window, Fl_modal) () { return (fl_Window)Fl::modal (); }
    FL_EXPORT_C (fl_Window, Fl_grab) () { return (fl_Window)Fl::grab (); }
    ...
    FL_EXPORT_C (int, Fl_event) () { return Fl::event (); }
    FL_EXPORT_C (int, Fl_event_x) () { return Fl::event_x (); }
    FL_EXPORT_C (int, Fl_event_y) () { return Fl::event_y (); }
    FL_EXPORT_C (int, Fl_event_x_root) () { return Fl::event_x_root (); }
    FL_EXPORT_C (int, Fl_event_y_root) () { return Fl::event_y_root (); }
    FL_EXPORT_C (int, Fl_event_dx) () { return Fl::event_dx (); }
    FL_EXPORT_C (int, Fl_event_dy) () { return Fl::event_dy (); }
    FL_EXPORT_C (void, Fl_get_mouse) (int * x, int * y)
    {
        Fl::get_mouse (*x, *y);
    }
    FL_EXPORT_C (int, Fl_event_clicks) () { return Fl::event_clicks (); }
    FL_EXPORT_C (void, Fl_set_event_clicks) (int i) { Fl::event_clicks (i); }
    FL_EXPORT_C (int, Fl_event_is_click) () { return Fl::event_is_click (); }
    FL_EXPORT_C (void, Fl_set_event_is_click) (int i)
    {
        Fl::event_is_click (i);
    }
    FL_EXPORT_C (int, Fl_event_button) () { return Fl::event_button (); }
    FL_EXPORT_C (int, Fl_event_state) () { return Fl::event_state (); }
    FL_EXPORT_C (int, Fl_contains_event_state) (int i)
    {
        return Fl::event_state (i);
    }
    FL_EXPORT_C (int, Fl_event_key) () { return Fl::event_key (); }
    ...
    FL_EXPORT_C (int, Fl_get_key) (int key) { return Fl::get_key (key); }
    FL_EXPORT_C (const char *, Fl_event_text) () { return Fl::event_text (); }
    FL_EXPORT_C (int, Fl_event_length) () { return Fl::event_length (); }
    FL_EXPORT_C (int, Fl_compose) (int * del) { return Fl::compose (*del); }
    FL_EXPORT_C (void, Fl_compose_reset) () { Fl::compose_reset (); }
    ...
    FL_EXPORT_C (void, Fl_enable_im) () { return Fl::enable_im (); }
    FL_EXPORT_C (void, Fl_disable_im) () { return Fl::disable_im (); }
    ...
    FL_EXPORT_C (fl_Widget, Fl_pushed) () { return (fl_Widget)Fl::pushed (); }
    FL_EXPORT_C (void, Fl_set_pushed) (fl_Widget widget)
    {
        Fl::pushed ((static_cast<Fl_Widget *> (widget)));
    }
    FL_EXPORT_C (fl_Widget, Fl_focus) () { return (fl_Widget)Fl::focus (); }
    ...
    FL_EXPORT_C (int, Fl_dnd) () { return Fl::dnd (); }
    ...
    FL_EXPORT_C (int, Fl_x) () { return Fl::x (); }
    FL_EXPORT_C (int, Fl_y) () { return Fl::y (); }
    FL_EXPORT_C (int, Fl_w) () { return Fl::w (); }
    FL_EXPORT_C (int, Fl_h) () { return Fl::h (); }
    FL_EXPORT_C (int, Fl_screen_count) () { return Fl::screen_count (); }
    ...
    FL_EXPORT_C (void, Fl_free_color) (Fl_Color i) { Fl::free_color (i); }
    ...
    FL_EXPORT_C (Fl_Font, Fl_set_fonts) () { return Fl::set_fonts (); }
    ...
    FL_EXPORT_C(void,Fl_set_labeltype)(Fl_Labeltype labeltype,fl_Label_Draw_F* label_draw_f,fl_Label_Measure_F* label_measure_f)
    {
        ...
        Fl::set_labeltype (labeltype, C_to_Fl_Label_Draw_F::intercept,
                           C_to_Fl_Label_Measure_F::intercept);
    }
    // FL_EXPORT_C(void,Fl_set_labeltype_by_labeltype)(Fl_Labeltype to
    // ,Fl_Labeltype from){
    ...
    {
        Fl::set_boxtype (boxtype, box_draw_f, offsetX, offsetY, offsetW,
                         offsetH);
    }
    ...
    FL_EXPORT_C (int, Fl_draw_box_active) () { return Fl::draw_box_active (); }
    ...
    FL_EXPORT_C (int, Fl_event_shift) () { return Fl::event_shift (); }
    FL_EXPORT_C (int, Fl_event_ctrl) () { return Fl::event_ctrl (); }
    FL_EXPORT_C (int, Fl_event_command) () { return Fl::event_command (); }
    FL_EXPORT_C (int, Fl_event_alt) () { return Fl::event_alt (); }
    FL_EXPORT_C (int, Fl_event_buttons) () { return Fl::event_buttons (); }
    FL_EXPORT_C (int, Fl_event_button1) () { return Fl::event_button1 (); }
    FL_EXPORT_C (int, Fl_event_button2) () { return Fl::event_button2 (); }
    FL_EXPORT_C (int, Fl_event_button3) () { return Fl::event_button3 (); }
    FL_EXPORT_C (void, Fl_set_idle) (fl_Old_Idle_Handler cb)
    {
        Fl::set_idle (cb);
    }
    FL_EXPORT_C (void, Fl_release) () { Fl::release (); }
    FL_EXPORT_C (void, Fl_set_visible_focus) (int v) { Fl::visible_focus (v); }
    FL_EXPORT_C (int, Fl_visible_focus) () { return Fl::visible_focus (); }
    FL_EXPORT_C (void, Fl_set_dnd_text_ops) (int v) { Fl::dnd_text_ops (v); }
    FL_EXPORT_C (int, Fl_dnd_text_ops) () { return Fl::dnd_text_ops (); }
    FL_EXPORT_C (int, Fl_lock) () { return Fl::lock (); }
    FL_EXPORT_C (void, Fl_unlock) () { Fl::unlock (); }
    FL_EXPORT_C (void, Fl_awake) () { Fl::awake ((void *)0); }
    ...
    FL_EXPORT_C (void *, Fl_thread_message) () { return Fl::thread_message (); }
    ...
    FL_EXPORT_C (void, Fl_do_widget_deletion) () { Fl::do_widget_deletion (); }
