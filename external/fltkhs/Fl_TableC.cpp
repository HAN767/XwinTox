#include "Fl_TableC.h"
#ifdef __cplusplus
Fl_DerivedTable::Fl_DerivedTable (int X, int Y, int W, int H, const char * l,
...
Fl_DerivedTable::Fl_DerivedTable (int X, int Y, int W, int H,
                                  fl_Table_Virtual_Funcs * funcs)
    : Fl_Table (X, Y, W, H, 0)
{
    overriddenFuncs = funcs;
...
void * Fl_DerivedTable::get_other_data () { return this->other_data; }
void Fl_DerivedTable::set_other_data (void * data) { this->other_data = data; }
int Fl_DerivedTable::find_cell (TableContext context, int R, int C, int & X,
                                int & Y, int & W, int & H)
{
...
void Fl_DerivedTable::draw_box () { Fl_Table::draw_box (); }
void Fl_DerivedTable::draw_box (Fl_Boxtype t, Fl_Color c)
{
    Fl_Table::draw_box (t, c);
}
void Fl_DerivedTable::draw_box (Fl_Boxtype t, int x, int y, int w, int h,
                                Fl_Color c)
{
    Fl_Table::draw_box (t, x, y, w, h, c);
}
void Fl_DerivedTable::draw_backdrop () { Fl_Table::draw_backdrop (); }
void Fl_DerivedTable::draw_focus () { Fl_Table::draw_focus (); }
void Fl_DerivedTable::draw_focus (Fl_Boxtype t, int x, int y, int w, int h)
{
    Fl_Table::draw_focus (t, x, y, w, h);
}
void Fl_DerivedTable::draw_label () { Fl_Table::draw_label (); }
void Fl_DerivedTable::draw_label (int x, int y, int w, int h,
                                  Fl_Align alignment)
{
...
Fl_Group * Fl_DerivedTable::as_group ()
{
    ...
    if (this->overriddenFuncs->as_group != NULL)
    {
        grp = (static_cast<Fl_Group *> (
            this->overriddenFuncs->as_group ((fl_Table) this)));
    }
    else
    {
...
Fl_Window * Fl_DerivedTable::as_window ()
{
    ...
    if (this->overriddenFuncs->as_window != NULL)
    {
        win = (static_cast<Fl_Window *> (
            this->overriddenFuncs->as_window ((fl_Table) this)));
    }
    else
    {
...
Fl_Gl_Window * Fl_DerivedTable::as_gl_window ()
{
    ...
    if (this->overriddenFuncs->as_gl_window != NULL)
    {
        win = (static_cast<Fl_Gl_Window *> (
            this->overriddenFuncs->as_gl_window ((fl_Table) this)));
    }
    else
    {
...
void Fl_DerivedTable::draw_cell (TableContext tableContext, int R, int C, int X,
                                 int Y, int W, int H)
{
...
EXPORT
{
    ...
    {
        fl_Table_Virtual_Funcs * ptr =
            (fl_Table_Virtual_Funcs *)malloc (sizeof (fl_Table_Virtual_Funcs));
        ptr->draw         = NULL;
        ptr->handle       = NULL;
        ptr->resize       = NULL;
        ptr->show         = NULL;
    ...
    {
        (static_cast<Fl_DerivedTable *> (table))
    ...
    FL_EXPORT_C (void *, Fl_Table_user_data) (fl_Table table)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_DerivedTable *> (table))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Table *> (table))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (static_cast<Fl_DerivedTable *> (table))
    ...
    {
        return (fl_Window) (static_cast<Fl_DerivedTable *> (table))
            ->top_window ();
    }
    ...
    {
        return (fl_Gl_Window) (static_cast<Fl_Table *> (table))
            ->as_gl_window ();
    }
    FL_EXPORT_C (fl_Gl_Window, Fl_Table_as_gl_window) (fl_Table table)
    {
        return (fl_Gl_Window) (static_cast<Fl_DerivedTable *> (table))
            ->as_gl_window ();
    }
    ...
    {
        (static_cast<Fl_DerivedTable *> (self))
