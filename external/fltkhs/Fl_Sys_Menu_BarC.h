...
EXPORT
{
    ...
    //  FL_EXPORT_C( fl_Menu_Item,
    //  Fl_Sys_Menu_Bar_find_item_with_cb)(fl_Sys_Menu_Bar sys_menu_bar,
    ...
    //  FL_EXPORT_C(int, Fl_Sys_Menu_Bar_find_index_with_cb)(fl_Sys_Menu_Bar
    //  sys_menu_bar, fl_Callback cb); Don't know how to do this
