...
EXPORT
{
    ...
    FL_EXPORT_C (void, flc_glutMainLoop) () { glutMainLoop (); }
    ...
    FL_EXPORT_C (void, flc_glutPostRedisplay) () { glutPostRedisplay (); }
    FL_EXPORT_C (void, flc_glutPostWindowRedisplay) (int win)
    {
        glutPostWindowRedisplay (win);
    }
    FL_EXPORT_C (void, flc_glutSwapBuffers) () { glutSwapBuffers (); }
    FL_EXPORT_C (int, flc_glutGetWindow) () { return glutGetWindow (); }
    FL_EXPORT_C (void, flc_glutSetWindow) (int win) { glutSetWindow (win); }
    ...
    FL_EXPORT_C (void, flc_glutPopWindow) () { glutPopWindow (); }
    FL_EXPORT_C (void, flc_glutPushWindow) () { glutPushWindow (); }
    FL_EXPORT_C (void, flc_glutIconifyWindow) () { glutIconifyWindow (); }
    FL_EXPORT_C (void, flc_glutShowWindow) () { glutShowWindow (); }
    FL_EXPORT_C (void, flc_glutHideWindow) () { glutHideWindow (); }
    FL_EXPORT_C (void, flc_glutFullScreen) () { glutFullScreen (); }
    ...
    FL_EXPORT_C (void, flc_glutEstablishOverlay) () { glutEstablishOverlay (); }
    FL_EXPORT_C (void, flc_glutRemoveOverlay) () { glutRemoveOverlay (); }
    ...
    FL_EXPORT_C (void, flc_glutShowOverlay) () { glutShowOverlay (); }
    FL_EXPORT_C (void, flc_glutHideOverlay) () { glutHideOverlay (); }
    ...
    FL_EXPORT_C (int, flc_glutGetMenu) () { return glutGetMenu (); }
    FL_EXPORT_C (void, flc_glutSetMenu) (int m) { glutSetMenu (m); }
    ...
    FL_EXPORT_C (void, flc_glutAttachMenu) (int b) { glutAttachMenu (b); }
    FL_EXPORT_C (void, flc_glutDetachMenu) (int b) { glutDetachMenu (b); }
    FL_EXPORT_C (int, flc_glutGet) (GLenum type) { return glutGet (type); }
    FL_EXPORT_C (int, flc_glutDeviceGet) (GLenum type)
    {
        return glutDeviceGet (type);
    }
    FL_EXPORT_C (int, flc_glutGetModifiers) () { return glutGetModifiers (); }
    ...
    FL_EXPORT_C (void, flc_glutWireDodecahedron) () { glutWireDodecahedron (); }
    ...
    FL_EXPORT_C (void, flc_glutWireOctahedron) () { glutWireOctahedron (); }
    FL_EXPORT_C (void, flc_glutSolidOctahedron) () { glutSolidOctahedron (); }
    FL_EXPORT_C (void, flc_glutWireTetrahedron) () { glutWireTetrahedron (); }
    FL_EXPORT_C (void, flc_glutSolidTetrahedron) () { glutSolidTetrahedron (); }
    FL_EXPORT_C (void, flc_glutWireIcosahedron) () { glutWireIcosahedron (); }
    FL_EXPORT_C (void, flc_glutSolidIcosahedron) () { glutSolidIcosahedron (); }
    ...
    FL_EXPORT_C (void, flc_glutIdleFunc) (void (*f) ()) { glutIdleFunc (f); }
