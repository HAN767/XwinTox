...
EXPORT
{
    ...
    {
        return (fl_Group) (fl_Group) (static_cast<Fl_Wizard *> (wizard))
            ->parent ();
    }
    FL_EXPORT_C (void, Fl_Wizard_set_parent) (fl_Wizard wizard, fl_Group grp)
    {
        (static_cast<Fl_Wizard *> (wizard))
            ->parent ((static_cast<Fl_Wizard *> (grp)));
    }
    ...
    FL_EXPORT_C (void *, Fl_Wizard_user_data) (fl_Wizard wizard)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Wizard *> (wizard))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (static_cast<Fl_Wizard *> (wizard))
    ...
    {
        return (fl_Window) (static_cast<Fl_Wizard *> (wizard))
    ...
    {
        return (fl_Gl_Window) (static_cast<Fl_Wizard *> (wizard))
            ->as_gl_window ();
    }
