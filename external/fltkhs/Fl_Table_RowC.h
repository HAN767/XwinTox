...
/* Inherited from Fl_Table_Row */
    ...
    class Fl_DerivedTable_Row : public Fl_Table_Row
    {
      ...
      public:
        ...
        void destroy_data ();
        int find_cell (TableContext context, int R, int C, int & X, int & Y,
                       int & W, int & H);
        void draw_box ();
        ...
        virtual void draw_cell (TableContext tableContext, int R, int C, int X,
                                int Y, int W, int H);
        virtual void clear ();
        virtual void rows (int val);
        virtual void cols (int val);
        Fl_DerivedTable_Row (int X, int Y, int W, int H, const char * l,
                             fl_Table_Row_Virtual_Funcs * funcs);
        Fl_DerivedTable_Row (int X, int Y, int W, int H,
                             fl_Table_Row_Virtual_Funcs * funcs);
        ~Fl_DerivedTable_Row ();
    };
#endif
