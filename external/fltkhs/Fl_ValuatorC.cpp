...
#ifdef __cplusplus
Fl_DerivedValuator::Fl_DerivedValuator (int X, int Y, int W, int H,
                                        const char * l,
                                        fl_Valuator_Virtual_Funcs * funcs)
...
void * Fl_DerivedValuator::get_other_data () { return this->other_data; }
...
void Fl_DerivedValuator::draw_box () { Fl_Valuator::draw_box (); }
void Fl_DerivedValuator::draw_box (Fl_Boxtype t, Fl_Color c)
{
    Fl_Valuator::draw_box (t, c);
}
void Fl_DerivedValuator::draw_box (Fl_Boxtype t, int x, int y, int w, int h,
                                   Fl_Color c)
{
    Fl_Valuator::draw_box (t, x, y, w, h, c);
}
void Fl_DerivedValuator::draw_backdrop () { Fl_Valuator::draw_backdrop (); }
void Fl_DerivedValuator::draw_focus () { Fl_Valuator::draw_focus (); }
void Fl_DerivedValuator::draw_focus (Fl_Boxtype t, int x, int y, int w, int h)
{
    Fl_Valuator::draw_focus (t, x, y, w, h);
}
void Fl_DerivedValuator::draw_label () { Fl_Valuator::draw_label (); }
void Fl_DerivedValuator::draw_label (int x, int y, int w, int h,
                                     Fl_Align alignment)
{
...
Fl_Window * Fl_DerivedValuator::as_window ()
{
    ...
    if (this->overriddenFuncs->as_window != NULL)
    {
        win = (static_cast<Fl_Window *> (
            this->overriddenFuncs->as_window ((fl_Box) this)));
    }
    else
    {
...
Fl_Gl_Window * Fl_DerivedValuator::as_gl_window ()
{
    ...
    if (this->overriddenFuncs->as_gl_window != NULL)
    {
        win = (static_cast<Fl_Gl_Window *> (
            this->overriddenFuncs->as_gl_window ((fl_Box) this)));
    }
    else
    {
...
EXPORT
{
    ...
    {
        fl_Valuator_Virtual_Funcs * ptr = (fl_Valuator_Virtual_Funcs *)malloc (
            sizeof (fl_Valuator_Virtual_Funcs));
        ptr->draw         = NULL;
        ptr->handle       = NULL;
        ptr->resize       = NULL;
        ptr->show         = NULL;
    ...
    {
        return (static_cast<Fl_DerivedValuator *> (valuator))
            ->Fl_Valuator::handle (event);
    }
    ...
    {
        (static_cast<Fl_DerivedValuator *> (valuator))
            ->Fl_Valuator::resize (x, y, w, h);
    }
    ...
    {
        return (fl_Window) (static_cast<Fl_DerivedValuator *> (widget))
            ->window ();
    }
    ...
    {
        return (fl_Gl_Window) (static_cast<Fl_DerivedValuator *> (valuator))
            ->Fl_Valuator::as_gl_window ();
    }
    ...
    {
        return (fl_Group) (static_cast<Fl_DerivedValuator *> (valuator))
            ->parent ();
    }
    ...
    FL_EXPORT_C (void *, Fl_Valuator_user_data) (fl_Valuator valuator)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_DerivedValuator *> (valuator))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Valuator *> (valuator))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        fl_Valuator_Virtual_Funcs * funcs =
            Fl_Valuator_default_virtual_funcs ();
        Fl_DerivedValuator * valuator =
            new Fl_DerivedValuator (x, y, w, h, label, funcs);
    ...
    FL_EXPORT_C (fl_Valuator, Fl_Valuator_New) (int x, int y, int w, int h)
    {
        fl_Valuator_Virtual_Funcs * funcs =
            Fl_Valuator_default_virtual_funcs ();
        Fl_DerivedValuator * valuator =
            new Fl_DerivedValuator (x, y, w, h, 0, funcs);
