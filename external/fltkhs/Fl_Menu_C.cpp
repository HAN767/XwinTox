...
#include "UtilsC.h"
#ifdef __cplusplus
Fl_DerivedMenu_::Fl_DerivedMenu_ (int X, int Y, int W, int H, const char * l,
                                  fl_Menu__Virtual_Funcs * funcs)
    : Fl_Menu_ (X, Y, W, H, l)
{
    overriddenFuncs = funcs;
    other_data      = 0;
}
Fl_DerivedMenu_::Fl_DerivedMenu_ (int X, int Y, int W, int H,
                                  fl_Menu__Virtual_Funcs * funcs)
    : Fl_Menu_ (X, Y, W, H, 0)
{
    overriddenFuncs = funcs;
...
void * Fl_DerivedMenu_::get_other_data () { return this->other_data; }
void Fl_DerivedMenu_::set_other_data (void * data) { this->other_data = data; }
...
void Fl_DerivedMenu_::draw () { this->overriddenFuncs->draw ((fl_Menu_) this); }
void Fl_DerivedMenu_::draw_box () { Fl_Widget::draw_box (); }
Fl_Window * Fl_DerivedMenu_::as_window ()
{
    ...
    if (this->overriddenFuncs->as_window != NULL)
    {
        win = (static_cast<Fl_Window *> (
            this->overriddenFuncs->as_window ((fl_Menu_) this)));
    }
    else
    {
...
Fl_Group * Fl_DerivedMenu_::as_group ()
{
    ...
    {
        win = (static_cast<Fl_Group *> (
            this->overriddenFuncs->as_group ((fl_Menu_) this)));
    }
    else
    {
...
Fl_Group * Fl_DerivedMenu_::as_group_super () { return Fl_Menu_::as_group (); }
Fl_Gl_Window * Fl_DerivedMenu_::as_gl_window ()
{
    ...
    if (this->overriddenFuncs->as_gl_window != NULL)
    {
        win = (static_cast<Fl_Gl_Window *> (
            this->overriddenFuncs->as_gl_window ((fl_Menu_) this)));
    }
    else
    {
...
EXPORT
{
    ...
    {
        fl_Menu__Virtual_Funcs * ptr =
            (fl_Menu__Virtual_Funcs *)malloc (sizeof (fl_Menu__Virtual_Funcs));
        ptr->draw         = NULL;
        ptr->handle       = NULL;
        ptr->resize       = NULL;
        ptr->show         = NULL;
    ...
    {
        return (fl_Window) (static_cast<Fl_DerivedMenu_ *> (menu_))
            ->as_window ();
    }
    FL_EXPORT_C (fl_Group, Fl_Menu__as_group_super) (fl_Menu_ menu_)
    {
        return (fl_Group) (static_cast<Fl_DerivedMenu_ *> (menu_))
            ->as_group_super ();
    }
    ...
    {
        return (fl_Gl_Window) (static_cast<Fl_Menu_ *> (menu_))
            ->as_gl_window ();
    }
    FL_EXPORT_C (fl_Gl_Window, Fl_Menu__as_gl_window) (fl_Menu_ menu_)
    {
        return (fl_Gl_Window) (static_cast<Fl_DerivedMenu_ *> (menu_))
            ->as_gl_window ();
    };
    ...
    {
        (static_cast<Fl_DerivedMenu_ *> (menu_))
    ...
    // }
    // FL_EXPORT_C(void, Fl_Menu__draw_box_with_tc)(fl_Menu_ Menu_,Fl_Boxtype t,
    // Fl_Color c){
    //  (static_cast<Fl_DerivedMenu_*>(Menu_))->draw_box(t,c);
    // }
    // FL_EXPORT_C(void, Fl_Menu__draw_box_with_txywhc)(fl_Menu_
    // Menu_,Fl_Boxtype t, int x,int y,int w,int h, Fl_Color c){
    ...
    // }
    // FL_EXPORT_C(void, Fl_Menu__draw_focus_with_txywh)(fl_Menu_
    // Menu_,Fl_Boxtype t, int x,int y,int w,int h){
    ...
    FL_EXPORT_C (void *, Fl_Menu__user_data) (fl_Menu_ menu_)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_DerivedMenu_ *> (menu_))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Menu_ *> (menu_))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (static_cast<Fl_DerivedMenu_ *> (menu_))
    ...
    // FL_EXPORT_C(void,Fl_Menu__draw_label_with_xywh_alignment)(fl_Menu_
    // menu_,int x,int y,int w,int h,Fl_Align alignment){
    ...
    FL_EXPORT_C(fl_Menu_, Fl_Menu__New_WithLabel)(int x, int y, int w, int h, const char* label)
    {
        ...
        Fl_DerivedMenu_ * menu_ =
            new Fl_DerivedMenu_ (x, y, w, h, label, funcs);
    ...
    {
        return (static_cast<Fl_DerivedMenu_ *> (menu_))
            ->item_pathname (name, namelen,
                             (static_cast<Fl_Menu_Item *> (finditem)));
    }
    ...
    {
        return (fl_Menu_Item) (static_cast<Fl_DerivedMenu_ *> (menu_))
            ->picked ((static_cast<Fl_Menu_Item *> (item)));
    }
    ...
    {
        return (static_cast<Fl_DerivedMenu_ *> (menu_))
            ->find_index ((static_cast<Fl_Menu_Item *> (item)));
    }
    ...
    FL_EXPORT_C(int,Fl_Menu__insert)(fl_Menu_ menu_,int index,char* name,int shortcut,fl_Callback* cb)
    {
        ...
        return callback_interceptor->menu_insert (
            (static_cast<Fl_DerivedMenu_ *> (menu_)), index, name, shortcut, 0);
    }
    FL_EXPORT_C(int,Fl_Menu__insert_with_flags)(fl_Menu_ menu_,int index,char* name,int shortcut,fl_Callback* cb,int flags)
    {
        C_to_Fl_Callback * callback_interceptor = new C_to_Fl_Callback (cb);
        return callback_interceptor->menu_insert (
            (static_cast<Fl_DerivedMenu_ *> (menu_)), index, name, shortcut,
            flags);
    }
    ...
    {
        C_to_Fl_Callback * callback_interceptor =
            new C_to_Fl_Callback (cb, user_data);
        return callback_interceptor->menu_insert (
            (static_cast<Fl_DerivedMenu_ *> (menu_)), index, name, shortcut,
            flags);
    }
    FL_EXPORT_C(int,Fl_Menu__add_with_user_data)(fl_Menu_ menu_,char* name,int shortcut,fl_Callback* cb,void* user_data)
    {
        C_to_Fl_Callback * callback_interceptor =
            new C_to_Fl_Callback (cb, user_data);
        return callback_interceptor->menu_add (
            (static_cast<Fl_DerivedMenu_ *> (menu_)), name, shortcut, 0);
    }
    FL_EXPORT_C(int,Fl_Menu__add_with_flags)(fl_Menu_ menu_,char* name,int shortcut,fl_Callback* cb,int flags)
    {
        C_to_Fl_Callback * callback_interceptor = new C_to_Fl_Callback (cb);
        return callback_interceptor->menu_add (
            (static_cast<Fl_DerivedMenu_ *> (menu_)), name, shortcut, flags);
    }
    ...
    {
        return (static_cast<Fl_DerivedMenu_ *> (menu_))
            ->value (static_cast<Fl_Menu_Item *> (item));
    }
    FL_EXPORT_C(fl_Menu_Item, Fl_Menu__get_menu_item_by_index)(fl_Menu_ menu_,  int i)
    {
        return (fl_Menu_Item) (
            static_cast<Fl_DerivedMenu_ *> (menu_)->get_menu_item_by_index (i));
    }
