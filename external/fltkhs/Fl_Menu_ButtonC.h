...
EXPORT
{
    ...
    //  Fl_Menu_Button_find_item_with_cb)(fl_Menu_Button menu_button,
    ...
    //  FL_EXPORT_C(int, Fl_Menu_Button_find_index_with_cb)(fl_Menu_Button
    //  menu_button, fl_Callback cb); Don't know how to do this
