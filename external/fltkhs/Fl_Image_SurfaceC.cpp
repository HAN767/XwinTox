...
EXPORT
{
    ...
    {
        (static_cast<Fl_Image_Surface *> (image_surface))
            ->draw ((static_cast<Fl_Widget *> (widget)), delta_x, delta_y);
    }
    ...
    {
        return (fl_RGB_Image) (static_cast<Fl_Image_Surface *> (image_surface))
            ->image ();
    }
#ifdef __cplusplus
}
