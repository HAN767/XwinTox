...
EXPORT
{
    ...
    //  FL_EXPORT_C( fl_Menu_Item, Fl_Choice_find_item_with_cb)(fl_Choice
    //  choice, fl_Callback cb); Don't know how to do this
    ...
    //  FL_EXPORT_C(int, Fl_Choice_find_index_with_cb)(fl_Choice choice,
