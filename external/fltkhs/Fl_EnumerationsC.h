...
#define FL_OSHADOW_BOX (Fl_Boxtype) (fl_define_FL_OVAL_BOXC () + 1)
#define FL_OVAL_FRAME (Fl_Boxtype) (fl_define_FL_OVAL_BOXC () + 2)
#define FL_OFLAT_BOX (Fl_Boxtype) (fl_define_FL_OVAL_BOXC () + 3)
...
#define FL_PLASTIC_THIN_UP_BOX                                                 \
    (Fl_Boxtype) (fl_define_FL_PLASTIC_UP_BOXC () + 4)
#define FL_PLASTIC_THIN_DOWN_BOX                                               \
    (Fl_Boxtype) (fl_define_FL_PLASTIC_UP_BOXC () + 5)
#define FL_PLASTIC_ROUND_UP_BOX                                                \
    (Fl_Boxtype) (fl_define_FL_PLASTIC_UP_BOXC () + 6)
#define FL_PLASTIC_ROUND_DOWN_BOX                                              \
    (Fl_Boxtype) (fl_define_FL_PLASTIC_UP_BOXC () + 7)
