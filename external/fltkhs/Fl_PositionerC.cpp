...
EXPORT
{
    ...
    {
        return (fl_Group) (static_cast<Fl_Positioner *> (positioner))
            ->parent ();
    }
    FL_EXPORT_C(void,Fl_Positioner_set_parent)(fl_Positioner positioner,fl_Group grp)
    {
        (static_cast<Fl_Positioner *> (positioner))
    ...
    FL_EXPORT_C (void *, Fl_Positioner_user_data) (fl_Positioner positioner)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Positioner *> (positioner))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (static_cast<Fl_Positioner *> (positioner))
    ...
    {
        return (fl_Gl_Window) (static_cast<Fl_Positioner *> (positioner))
            ->as_gl_window ();
    }
