...
EXPORT
{
    ...
    {
        (static_cast<Fl_Repeat_Button *> (b))
    ...
    FL_EXPORT_C (void *, Fl_Repeat_Button_user_data) (fl_Repeat_Button b)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Repeat_Button *> (b))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (static_cast<Fl_Repeat_Button *> (b))
    ...
    {
        return (fl_Window) (static_cast<Fl_Repeat_Button *> (repeat_button))
            ->window ();
    }
    ...
    {
        return (fl_Group) (static_cast<Fl_Repeat_Button *> (repeat_button))
            ->as_group ();
    }
    FL_EXPORT_C(fl_Gl_Window,Fl_Repeat_Button_as_gl_window)(fl_Repeat_Button repeat_button)
    {
        return (fl_Gl_Window) (static_cast<Fl_Repeat_Button *> (repeat_button))
            ->as_gl_window ();
    }
