...
EXPORT
{
    class Fl_DerivedMenu_ : public Fl_Menu_
    {
      ...
      public:
        ...
        Fl_DerivedMenu_ (int X, int Y, int W, int H, const char * l,
                         fl_Menu__Virtual_Funcs * funcs);
        Fl_DerivedMenu_ (int X, int Y, int W, int H,
                         fl_Menu__Virtual_Funcs * funcs);
        ~Fl_DerivedMenu_ ();
    };
#endif
    ...
    //  FL_EXPORT_C( fl_Menu_Item, Fl_Menu__find_item_with_cb)(fl_Menu_ menu_,
    //  fl_Callback cb); Don't know how to do this
    ...
    //  FL_EXPORT_C(int, Fl_Menu__find_index_with_cb)(fl_Menu_ menu_,
    //  fl_Callback cb); Don't know how to do this
