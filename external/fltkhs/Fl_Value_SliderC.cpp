...
EXPORT
{
    ...
    FL_EXPORT_C(void*,Fl_Value_Slider_user_data)(fl_Value_Slider value_slider)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Value_Slider *> (value_slider))->user_data ()));
        if (stored_cb)
        {
    ...
    FL_EXPORT_C(fl_Value_Slider, Fl_Value_Slider_New_WithLabel)(int x, int y, int w, int h, const char* label)
    {
        Fl_Value_Slider * value_slider =
            new Fl_Value_Slider (x, y, w, h, label);
        return (static_cast<fl_Value_Slider> (value_slider));
    }
    ...
    {
        Fl_Hor_Value_Slider * hor_value_slider =
            new Fl_Hor_Value_Slider (x, y, w, h, label);
    ...
    {
        Fl_Hor_Value_Slider * hor_value_slider =
            new Fl_Hor_Value_Slider (x, y, w, h, 0);
