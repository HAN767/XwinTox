...
EXPORT
{
    ...
    {
        (static_cast<Fl_Progress *> (progress))
    ...
    FL_EXPORT_C (void *, Fl_Progress_user_data) (fl_Progress progress)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Progress *> (progress))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (static_cast<Fl_Progress *> (progress))
    ...
    {
        return (fl_Window) (static_cast<Fl_Progress *> (progress))
            ->top_window ();
    }
    ...
    {
        return (fl_Gl_Window) (static_cast<Fl_Progress *> (progress))
            ->as_gl_window ();
    }
