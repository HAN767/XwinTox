...
EXPORT
{
    class Fl_DerivedBox : public Fl_Box
    {
      ...
      public:
        ...
        Fl_DerivedBox (int X, int Y, int W, int H, const char * l,
                       fl_Box_Virtual_Funcs * funcs);
        Fl_DerivedBox (int X, int Y, int W, int H,
                       fl_Box_Virtual_Funcs * funcs);
        Fl_DerivedBox (Fl_Boxtype b, int X, int Y, int W, int H, const char * l,
                       fl_Box_Virtual_Funcs * funcs);
        ~Fl_DerivedBox ();
    };
#endif
