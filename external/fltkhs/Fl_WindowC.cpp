...
#ifdef __cplusplus
Fl_DerivedWindow::Fl_DerivedWindow (int X, int Y, int W, int H, const char * l,
                                    fl_Window_Virtual_Funcs * funcs)
    : Fl_Window (X, Y, W, H, l)
{
    overriddenFuncs = funcs;
    other_data      = 0;
}
Fl_DerivedWindow::Fl_DerivedWindow (int X, int Y, int W, int H,
                                    fl_Window_Virtual_Funcs * funcs)
    : Fl_Window (X, Y, W, H, 0)
{
    overriddenFuncs = funcs;
...
Fl_DerivedWindow::Fl_DerivedWindow (int W, int H, const char * l,
                                    fl_Window_Virtual_Funcs * funcs)
    : Fl_Window (W, H, l)
{
    overriddenFuncs = funcs;
...
Fl_DerivedWindow::Fl_DerivedWindow (int W, int H,
                                    fl_Window_Virtual_Funcs * funcs)
    : Fl_Window (W, H, 0)
{
    overriddenFuncs = funcs;
...
void * Fl_DerivedWindow::get_other_data () { return this->other_data; }
void Fl_DerivedWindow::set_other_data (void * data) { this->other_data = data; }
...
void Fl_DerivedWindow::draw_box () { Fl_Window::draw_box (); }
void Fl_DerivedWindow::draw_box (Fl_Boxtype t, Fl_Color c)
{
    Fl_Window::draw_box (t, c);
}
void Fl_DerivedWindow::draw_box (Fl_Boxtype t, int x, int y, int w, int h,
                                 Fl_Color c)
{
    Fl_Window::draw_box (t, x, y, w, h, c);
}
void Fl_DerivedWindow::draw_backdrop () { Fl_Window::draw_backdrop (); }
void Fl_DerivedWindow::draw_focus () { Fl_Window::draw_focus (); }
void Fl_DerivedWindow::draw_focus (Fl_Boxtype t, int x, int y, int w, int h)
{
    Fl_Window::draw_focus (t, x, y, w, h);
}
void Fl_DerivedWindow::draw_label () { Fl_Window::draw_label (); }
void Fl_DerivedWindow::draw_label (int x, int y, int w, int h,
                                   Fl_Align alignment)
{
...
void Fl_DerivedWindow::draw_children () { Fl_Window::draw_children (); }
...
int * Fl_DerivedWindow::sizes () { return Fl_Window::sizes (); }
...
void Fl_DerivedWindow::flush_super () { Fl_Window::flush (); }
...
void Fl_DerivedWindow::show_super () { Fl_Window::show (); }
...
void Fl_DerivedWindow::draw_super () { Fl_Window::draw (); }
...
EXPORT
{
    ...
    {
        fl_Window_Virtual_Funcs * ptr = (fl_Window_Virtual_Funcs *)malloc (
            sizeof (fl_Window_Virtual_Funcs));
        ptr->draw         = NULL;
        ptr->handle       = NULL;
        ptr->resize       = NULL;
        ptr->show         = NULL;
    ...
    {
        (static_cast<Fl_DerivedWindow *> (win))
    ...
    FL_EXPORT_C (void *, Fl_Window_user_data) (fl_Window win)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_DerivedWindow *> (win))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Window *> (win))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (static_cast<Fl_DerivedWindow *> (win))
    ...
    {
        return (fl_Gl_Window) (static_cast<Fl_DerivedWindow *> (win))
            ->as_gl_window ();
    }
    FL_EXPORT_C (fl_Window, Fl_Window_window) (fl_Window window)
    {
        return (fl_Window) (static_cast<Fl_DerivedWindow *> (window))
            ->window ();
    }
    ...
    {
        (static_cast<Fl_DerivedWindow *> (Window))
    ...
    {
        return (fl_Widget) (static_cast<Fl_DerivedWindow *> (win))
            ->resizable ();
    }
    ...
    {
        (static_cast<Fl_DerivedWindow *> (self))
    ...
    {
        fl_Window_Virtual_Funcs * funcs = Fl_Window_default_virtual_funcs ();
        Fl_DerivedWindow * window =
            new Fl_DerivedWindow (x, y, w, h, title, funcs);
        return (fl_Window)window;
    }
    ...
    {
        return (fl_Gl_Window) (static_cast<Fl_Window *> (window))
            ->as_gl_window ();
    };
    ...
    {
        Fl_Window::default_callback ((static_cast<Fl_DerivedWindow *> (win)),
                                     v);
    }
