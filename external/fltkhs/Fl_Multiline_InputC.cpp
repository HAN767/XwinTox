...
EXPORT
{
    ...
    {
        return (fl_Group) (static_cast<Fl_Multiline_Input *> (multiline_input))
            ->parent ();
    }
    FL_EXPORT_C(void,Fl_Multiline_Input_set_parent)(fl_Multiline_Input multiline_input,fl_Group grp)
    {
        (static_cast<Fl_Multiline_Input *> (multiline_input))
    ...
    {
        Fl_Multiline_Input * castedInput_dow =
            (static_cast<Fl_Multiline_Input *> (multiline_input));
    ...
    {
        return (fl_Window) (static_cast<Fl_Multiline_Input *> (multiline_input))
            ->window ();
    }
