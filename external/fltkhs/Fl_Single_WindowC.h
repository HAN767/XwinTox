...
EXPORT
{
    ...
    /* FL_EXPORT_C(void,         Fl_Single_Window_forms_end)(fl_Single_Window
     * win); */
    /* Fl_Window inherited */
...
// flush resize destructor, constructor
    ...
    class Fl_DerivedSingle_Window : public Fl_Single_Window
    {
      ...
      public:
        ...
        int * sizes ();
        Fl_DerivedSingle_Window (int X, int Y, int W, int H, const char * l,
                                 fl_Single_Window_Virtual_Funcs * funcs);
        Fl_DerivedSingle_Window (int X, int Y, int W, int H,
                                 fl_Single_Window_Virtual_Funcs * funcs);
        Fl_DerivedSingle_Window (int W, int H, const char * l,
                                 fl_Single_Window_Virtual_Funcs * funcs);
        Fl_DerivedSingle_Window (int W, int H,
                                 fl_Single_Window_Virtual_Funcs * funcs);
