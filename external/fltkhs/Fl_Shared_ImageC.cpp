...
EXPORT
{
    ...
    {
        return (fl_Image) (static_cast<DerivedShared_Image *> (shared_image))
            ->copy (W, H);
    }
    ...
    {
        return (static_cast<DerivedShared_Image *> (shared_image))
    ...
    {
        (static_cast<DerivedShared_Image *> (shared_image))
            ->color_average (c, i);
    }
