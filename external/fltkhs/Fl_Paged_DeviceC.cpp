...
EXPORT
{
    ...
    {
        return (static_cast<Fl_Paged_Device *> (paged_device))
            ->driver ((static_cast<Fl_Graphics_Driver *> (graphics_driver)));
    }
    FL_EXPORT_C(fl_Graphics_Driver,Fl_Paged_Device_driver)(fl_Paged_Device paged_device)
    {
        return (fl_Graphics_Driver) (
                   static_cast<Fl_Paged_Device *> (paged_device))
            ->driver ();
    }
    ...
    {
        return (static_cast<Fl_Paged_Device *> (paged_device))
            ->start_job (pagecount, frompage, topage);
    }
    ...
    {
        (static_cast<Fl_Paged_Device *> (paged_device))
            ->print_window_part (static_cast<Fl_Window *> (win), x, y, w, h, 0,
                                 delta_y);
    }
