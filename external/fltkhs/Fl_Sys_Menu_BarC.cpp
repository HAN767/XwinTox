...
EXPORT
{
    ...
    FL_EXPORT_C(void*,Fl_Sys_Menu_Bar_user_data)(fl_Sys_Menu_Bar sys_menu_bar)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Sys_Menu_Bar *> (sys_menu_bar))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Menu_Item *> (sys_menu_bar))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        Fl_Sys_Menu_Bar * sys_menu_bar =
            new Fl_Sys_Menu_Bar (x, y, w, h, label);
        return (static_cast<fl_Sys_Menu_Bar> (sys_menu_bar));
    }
    ...
    {
        return (fl_Menu_Item) (static_cast<Fl_Sys_Menu_Bar *> (sys_menu_bar))
    ...
    FL_EXPORT_C(int,Fl_Sys_Menu_Bar_insert)(fl_Sys_Menu_Bar sys_menu_bar,int index,char* name,int shortcut,fl_Callback* cb)
    {
        ...
        return callback_interceptor->menu_insert (
            (static_cast<Fl_Sys_Menu_Bar *> (sys_menu_bar)), index, name,
            shortcut, 0);
    }
    ...
    FL_EXPORT_C(int,Fl_Sys_Menu_Bar_add)(fl_Sys_Menu_Bar sys_menu_bar,char* name,int shortcut,fl_Callback* cb)
    {
        ...
        return callback_interceptor->menu_add (
            (static_cast<Fl_Sys_Menu_Bar *> (sys_menu_bar)), name, shortcut, 0);
    }
    ...
    FL_EXPORT_C(int,Fl_Sys_Menu_Bar_add_with_flags)(fl_Sys_Menu_Bar sys_menu_bar,char* name,int shortcut,fl_Callback* cb,int flags)
    {
        C_to_Fl_Callback * callback_interceptor = new C_to_Fl_Callback (cb);
        return callback_interceptor->menu_add (
            (static_cast<Fl_Sys_Menu_Bar *> (sys_menu_bar)), name, shortcut,
            flags);
    }
    ...
    {
        return (char *)(static_cast<Fl_Sys_Menu_Bar *> (sys_menu_bar))
            ->text (i);
    }
