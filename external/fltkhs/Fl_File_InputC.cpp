...
EXPORT
{
    ...
    {
        return (fl_Group) (static_cast<Fl_File_Input *> (file_input))
            ->parent ();
    }
    FL_EXPORT_C(void,Fl_File_Input_set_parent)(fl_File_Input file_input,fl_Group grp)
    {
        (static_cast<Fl_File_Input *> (file_input))
    ...
    FL_EXPORT_C (void *, Fl_File_Input_user_data) (fl_File_Input file_input)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_File_Input *> (file_input))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (fl_Window) (static_cast<Fl_File_Input *> (file_input))
            ->window ();
    }
    ...
    {
        return (fl_Gl_Window) (static_cast<Fl_File_Input *> (file_input))
            ->as_gl_window ();
    }
