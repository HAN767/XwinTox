#ifndef __FL_TYPES_H_
#define __FL_TYPES_H_
...
#define FL_SORT_ASCENDING                                                      \
    0 /**< sort browser items in ascending alphabetic order. */
#define FL_SORT_DESCENDING 1 /**< sort in descending order */
#ifndef INTERNAL_LINKAGE
    enum
    {
        FL_FILE_BROWSER_FILES,
        FL_FILE_BROWSER_DIRECTORIES
    };
    enum
    {
        FL_FILE_ICON_ANY,
...
#define GLUT_OVERLAY_DAMAGED 805
    typedef struct Fl_Glut_Bitmap_Font
    {
        Fl_Font font;
        Fl_Fontsize size;
    } Fl_Glut_Bitmap_Font;
    struct Fl_Glut_Bitmap_Font glutBitmap9By15, glutBitmap8By13,
        glutBitmapTimesRoman10, glutBitmapTimesRoman24, glutBitmapHelvetica10,
...
#define GLUT_STROKE_MONO_ROMAN (&glutStrokeMonoRoman)
    ...
    typedef fl_Image (fl_Shared_Image_Handler) (const char * name,
                                                uchar * header, int headerlen);
    ...
    typedef struct
    {
        ...
        /* From Fl_Table */
        void (*draw_cell) (fl_Table table, TableContextC context, int R, int C,
    ...
    typedef struct
    {
        ...
        void (*draw) (fl_Image image, int X, int Y, int W, int H, int cx,
                      int cy);
