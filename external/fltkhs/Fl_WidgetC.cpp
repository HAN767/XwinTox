...
#ifdef __cplusplus
Fl_DerivedWidget::Fl_DerivedWidget (int X, int Y, int W, int H, const char * l,
                                    fl_Widget_Virtual_Funcs * funcs)
    : Fl_Widget (X, Y, W, H, l)
{
    overriddenFuncs = funcs;
    other_data      = (void *)0;
}
Fl_DerivedWidget::Fl_DerivedWidget (int X, int Y, int W, int H,
                                    fl_Widget_Virtual_Funcs * funcs)
    : Fl_Widget (X, Y, W, H)
{
    overriddenFuncs = funcs;
...
void * Fl_DerivedWidget::get_other_data () { return this->other_data; }
void Fl_DerivedWidget::set_other_data (void * data) { this->other_data = data; }
...
void Fl_DerivedWidget::draw_box () { Fl_Widget::draw_box (); }
void Fl_DerivedWidget::draw_box (Fl_Boxtype t, Fl_Color c)
{
    Fl_Widget::draw_box (t, c);
}
void Fl_DerivedWidget::draw_box (Fl_Boxtype t, int x, int y, int w, int h,
                                 Fl_Color c)
{
    Fl_Widget::draw_box (t, x, y, w, h, c);
}
void Fl_DerivedWidget::draw_backdrop () { Fl_Widget::draw_backdrop (); }
void Fl_DerivedWidget::draw_focus () { Fl_Widget::draw_focus (); }
void Fl_DerivedWidget::draw_focus (Fl_Boxtype t, int x, int y, int w, int h)
{
    Fl_Widget::draw_focus (t, x, y, w, h);
}
void Fl_DerivedWidget::draw_label () { Fl_Widget::draw_label (); }
void Fl_DerivedWidget::draw_label (int x, int y, int w, int h,
                                   Fl_Align alignment)
{
...
Fl_Group * Fl_DerivedWidget::as_group ()
{
    ...
    if (this->overriddenFuncs->as_group != NULL)
    {
        grp = (static_cast<Fl_Group *> (
            this->overriddenFuncs->as_group ((fl_Widget) this)));
    }
    else
    {
...
Fl_Window * Fl_DerivedWidget::as_window ()
{
    ...
    if (this->overriddenFuncs->as_window != NULL)
    {
        win = (static_cast<Fl_Window *> (
            this->overriddenFuncs->as_window ((fl_Widget) this)));
    }
    else
    {
...
Fl_Gl_Window * Fl_DerivedWidget::as_gl_window ()
{
    ...
    if (this->overriddenFuncs->as_gl_window != NULL)
    {
        win = (static_cast<Fl_Gl_Window *> (
            this->overriddenFuncs->as_gl_window ((fl_Widget) this)));
    }
    else
    {
...
EXPORT
{
    ...
    {
        fl_Widget_Virtual_Funcs * ptr = (fl_Widget_Virtual_Funcs *)malloc (
            sizeof (fl_Widget_Virtual_Funcs));
        ptr->draw         = NULL;
        ptr->handle       = NULL;
        ptr->resize       = NULL;
        ptr->show         = NULL;
    ...
    {
        (static_cast<Fl_DerivedWidget *> (widget))
    ...
    FL_EXPORT_C (void *, Fl_Widget_user_data) (fl_Widget widget)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_DerivedWidget *> (widget))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Widget *> (widget))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (static_cast<Fl_DerivedWidget *> (widget))
    ...
    {
        return (fl_Window) (static_cast<Fl_DerivedWidget *> (widget))
            ->window ();
    }
    ...
    {
        return (fl_Group) (static_cast<Fl_DerivedWidget *> (widget))
            ->as_group ();
    }
    FL_EXPORT_C (fl_Gl_Window, Fl_Widget_as_gl_window_super) (fl_Widget widget)
    {
        return (fl_Gl_Window) (static_cast<Fl_Widget *> (widget))
            ->as_gl_window ();
    }
    FL_EXPORT_C (fl_Gl_Window, Fl_Widget_as_gl_window) (fl_Widget widget)
    {
        return (fl_Gl_Window) (static_cast<Fl_DerivedWidget *> (widget))
            ->as_gl_window ();
    }
