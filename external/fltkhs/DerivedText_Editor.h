...
class DerivedText_Editor : public Fl_Text_Editor
{
  ...
  public:
    ...
    static Key_Binding_With_Callback *
    convert_keybindings (Fl_Text_Editor::Key_Binding * bindings);
    ...
    {
        Key_Binding_With_Callback * default_bindings =
    ...
    void add_key_binding (int key, int state,
                          C_to_Fl_Callback * callback_context,
    ...
    C_to_Fl_Callback * bound_key_function (int key, int state,
                                           Key_Binding_With_Callback * list);
    ...
    void remove_key_binding (int key, int state,
                             Key_Binding_With_Callback ** list);
    void remove_key_binding (int key, int state);
    void replace_key_bindings (Key_Binding_With_Callback ** l1,
