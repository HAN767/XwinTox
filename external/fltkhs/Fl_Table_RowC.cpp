...
#ifdef __cplusplus
Fl_DerivedTable_Row::Fl_DerivedTable_Row (int X, int Y, int W, int H,
                                          const char * l,
                                          fl_Table_Virtual_Funcs * funcs)
...
void * Fl_DerivedTable_Row::get_other_data () { return this->other_data; }
...
int Fl_DerivedTable_Row::find_cell (TableContext context, int R, int C, int & X,
                                    int & Y, int & W, int & H)
{
...
void Fl_DerivedTable_Row::draw_box () { Fl_Table_Row::draw_box (); }
void Fl_DerivedTable_Row::draw_box (Fl_Boxtype t, Fl_Color c)
{
    Fl_Table_Row::draw_box (t, c);
}
void Fl_DerivedTable_Row::draw_box (Fl_Boxtype t, int x, int y, int w, int h,
                                    Fl_Color c)
{
    Fl_Table_Row::draw_box (t, x, y, w, h, c);
}
void Fl_DerivedTable_Row::draw_backdrop () { Fl_Table_Row::draw_backdrop (); }
void Fl_DerivedTable_Row::draw_focus () { Fl_Table_Row::draw_focus (); }
void Fl_DerivedTable_Row::draw_focus (Fl_Boxtype t, int x, int y, int w, int h)
{
    Fl_Table_Row::draw_focus (t, x, y, w, h);
}
void Fl_DerivedTable_Row::draw_label () { Fl_Table_Row::draw_label (); }
void Fl_DerivedTable_Row::draw_label (int x, int y, int w, int h,
                                      Fl_Align alignment)
{
...
Fl_Group * Fl_DerivedTable_Row::as_group ()
{
    ...
    {
        grp = (static_cast<Fl_Group *> (
            this->overriddenFuncs->as_group ((fl_Table_Row) this)));
    }
    else
    {
...
Fl_Window * Fl_DerivedTable_Row::as_window ()
{
    ...
    {
        win = (static_cast<Fl_Window *> (
            this->overriddenFuncs->as_window ((fl_Table_Row) this)));
    }
    else
    {
...
Fl_Gl_Window * Fl_DerivedTable_Row::as_gl_window ()
{
    ...
    {
        win = (static_cast<Fl_Gl_Window *> (
            this->overriddenFuncs->as_gl_window ((fl_Table_Row) this)));
    }
    else
    {
...
void Fl_DerivedTable_Row::draw_cell (TableContext tableContext, int R, int C,
                                     int X, int Y, int W, int H)
{
    TableContextC c = (TableContextC)-1;
    switch (tableContext)
    {
    case Fl_Table::CONTEXT_NONE:
    {
        c = CONTEXT_NONEC;
        break;
    }
    ...
    {
        c = CONTEXT_ROW_HEADERC;
        break;
    }
    case Fl_Table::CONTEXT_COL_HEADER:
    {
        c = CONTEXT_COL_HEADERC;
        break;
    }
    ...
    (*this->overriddenFuncs->draw_cell) ((fl_Table_Row) this, c, R, C, X, Y, W,
                                         H);
}
...
EXPORT
{
    ...
    {
        fl_Table_Row_Virtual_Funcs * ptr =
            (fl_Table_Row_Virtual_Funcs *)malloc (
                sizeof (fl_Table_Row_Virtual_Funcs));
        ptr->draw         = NULL;
        ptr->handle       = NULL;
        ptr->resize       = NULL;
        ptr->show         = NULL;
    ...
    {
        return (static_cast<Fl_DerivedTable_Row *> (self))
            ->handle_super (event);
    }
    FL_EXPORT_C (fl_Group, Fl_Table_Row_parent) (fl_Table_Row table_row)
    {
        return (fl_Group) (static_cast<Fl_DerivedTable_Row *> (table_row))
            ->parent ();
    }
    FL_EXPORT_C(void,Fl_Table_Row_set_parent)(fl_Table_Row table_row,fl_Group grp)
    {
        (static_cast<Fl_DerivedTable_Row *> (table_row))
    ...
    {
        return (static_cast<Fl_DerivedTable_Row *> (table_row))
            ->selection_color ();
    }
    ...
    {
        Fl_DerivedTable_Row * castedWindow =
            (static_cast<Fl_DerivedTable_Row *> (table_row));
    ...
    FL_EXPORT_C (void *, Fl_Table_Row_user_data) (fl_Table_Row table_row)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_DerivedTable_Row *> (table_row))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Table_Row *> (table_row))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (fl_Window) (static_cast<Fl_DerivedTable_Row *> (table_row))
            ->window ();
    }
    ...
    {
        return (fl_Group) (static_cast<Fl_Table_Row *> (table_row))
            ->as_group ();
    }
    ...
    {
        return (static_cast<Fl_DerivedTable_Row *> (table_row))
            ->add_resizable (*(static_cast<Fl_Widget *> (o)));
    }
    ...
    {
        (static_cast<Fl_DerivedTable_Row *> (self))
            ->insert (*(static_cast<Fl_Widget *> (w)),
                      (static_cast<Fl_Widget *> (before)));
    }
    FL_EXPORT_C (fl_Widget *, Fl_Table_Row_array) (fl_Table_Row self)
    {
        return (fl_Widget *)(static_cast<Fl_DerivedTable_Row *> (self))
            ->array ();
    }
    ...
    {
        return (static_cast<Fl_DerivedTable_Row *> (table_row))
            ->find ((static_cast<Fl_Widget *> (wgt)));
    }
    ...
    {
        Fl_DerivedTable_Row * t =
            (static_cast<Fl_DerivedTable_Row *> (table_row));
        Fl_Table_Row::TableContext context = t->callback_context ();
        TableContextC ret = (TableContextC)-1;
        switch (context)
        {
        case Fl_Table_Row::CONTEXT_NONE:
        {
            ret = CONTEXT_NONEC;
            break;
        }
        case Fl_Table_Row::CONTEXT_STARTPAGE:
        {
            ret = CONTEXT_STARTPAGEC;
            break;
        }
        case Fl_Table_Row::CONTEXT_ENDPAGE:
        {
            ret = CONTEXT_ENDPAGEC;
            break;
        }
        case Fl_Table_Row::CONTEXT_ROW_HEADER:
        {
            ret = CONTEXT_ROW_HEADERC;
            break;
        }
        case Fl_Table_Row::CONTEXT_COL_HEADER:
        {
            ret = CONTEXT_COL_HEADERC;
            break;
        }
        case Fl_Table_Row::CONTEXT_CELL:
        {
            ret = CONTEXT_CELLC;
            break;
        }
        case Fl_Table_Row::CONTEXT_TABLE:
        {
            ret = CONTEXT_TABLEC;
            break;
        }
        case Fl_Table_Row::CONTEXT_RC_RESIZE:
        {
            ret = CONTEXT_RC_RESIZEC;
            break;
        }
        default:
        {
    ...
    FL_EXPORT_C(void,Fl_Table_Row_do_callback)(fl_Table_Row table_row, TableContextC tableContext, int row, int col)
    {
        ...
        case CONTEXT_NONEC:
        {
            c = Fl_Table_Row::CONTEXT_NONE;
            break;
        }
        case CONTEXT_STARTPAGEC:
        {
            c = Fl_Table_Row::CONTEXT_STARTPAGE;
            break;
        }
        case CONTEXT_ENDPAGEC:
        {
            c = Fl_Table_Row::CONTEXT_ENDPAGE;
            break;
        }
        case CONTEXT_ROW_HEADERC:
        {
            c = Fl_Table_Row::CONTEXT_ROW_HEADER;
            break;
        }
        case CONTEXT_COL_HEADERC:
        {
            c = Fl_Table_Row::CONTEXT_COL_HEADER;
            break;
        }
        case CONTEXT_CELLC:
        {
            c = Fl_Table_Row::CONTEXT_CELL;
            break;
        }
        case CONTEXT_TABLEC:
        {
            c = Fl_Table_Row::CONTEXT_TABLE;
            break;
        }
        case CONTEXT_RC_RESIZEC:
        {
            c = Fl_Table_Row::CONTEXT_RC_RESIZE;
            break;
        }
        default:
        {
            c = (Fl_Table_Row::TableContext)-1;
            break;
        }
        }
        (static_cast<Fl_DerivedTable_Row *> (table_row))
            ->do_callback (c, row, col);
    }
    ...
    FL_EXPORT_C(int,  Fl_Table_Row_find_cell)(fl_Table_Row table_row, TableContextC context, int R, int C, int *X, int *Y, int *W, int *H)
    {
        ...
        case CONTEXT_NONEC:
        {
            c = Fl_Table::CONTEXT_NONE;
            break;
        }
        case CONTEXT_STARTPAGEC:
        {
            c = Fl_Table::CONTEXT_STARTPAGE;
            break;
        }
        case CONTEXT_ENDPAGEC:
        {
            c = Fl_Table::CONTEXT_ENDPAGE;
            break;
        }
        case CONTEXT_ROW_HEADERC:
        {
            c = Fl_Table::CONTEXT_ROW_HEADER;
            break;
        }
        case CONTEXT_COL_HEADERC:
        {
            c = Fl_Table::CONTEXT_COL_HEADER;
            break;
        }
        case CONTEXT_CELLC:
        {
            c = Fl_Table::CONTEXT_CELL;
            break;
        }
        case CONTEXT_TABLEC:
        {
            c = Fl_Table::CONTEXT_TABLE;
            break;
        }
        case CONTEXT_RC_RESIZEC:
        {
            c = Fl_Table::CONTEXT_RC_RESIZE;
            break;
        }
        default:
        {
            c = (Fl_Table::TableContext)-1;
            break;
        }
        }
        return (static_cast<Fl_DerivedTable_Row *> (table_row))
            ->find_cell (c, R, C, *X, *Y, *W, *H);
    }
    FL_EXPORT_C(fl_Table_Row, Fl_Table_Row_New_WithLabel)(int X, int Y, int W, int H, const char *l)
    {
        fl_Table_Row_Virtual_Funcs * funcs =
            Fl_Table_Row_default_virtual_funcs ();
        Fl_DerivedTable_Row * table =
            new Fl_DerivedTable_Row (X, Y, W, H, l, funcs);
    ...
    FL_EXPORT_C (fl_Table_Row, Fl_Table_Row_New) (int X, int Y, int W, int H)
    {
        fl_Table_Row_Virtual_Funcs * funcs =
            Fl_Table_Row_default_virtual_funcs ();
        Fl_DerivedTable_Row * table =
            new Fl_DerivedTable_Row (X, Y, W, H, funcs);
        return (fl_Table_Row)table;
    }
    ...
    {
        Fl_Table_Row::TableRowSelectMode m =
            (static_cast<Fl_DerivedTable_Row *> (table))->type ();
        TableRowSelectModeC mode = (TableRowSelectModeC)-1;
        switch (m)
        {
        case Fl_Table_Row::SELECT_NONE:
        {
            mode = SELECT_NONEC;
            break;
        }
        case Fl_Table_Row::SELECT_SINGLE:
        {
            mode = SELECT_SINGLEC;
            break;
        }
        case Fl_Table_Row::SELECT_MULTI:
        {
            mode = SELECT_MULTIC;
            break;
        }
    ...
    {
        Fl_Table_Row::TableRowSelectMode mode =
            (Fl_Table_Row::TableRowSelectMode)-1;
        switch (m)
        {
        case SELECT_NONEC:
        {
            mode = Fl_Table_Row::SELECT_NONE;
            break;
        }
        case SELECT_SINGLEC:
        {
            mode = Fl_Table_Row::SELECT_SINGLE;
            break;
        }
        case SELECT_MULTIC:
        {
            mode = Fl_Table_Row::SELECT_MULTI;
            break;
        }
        default:
        {
            mode = (Fl_Table_Row::TableRowSelectMode)-1;
            break;
        }
        }
    ...
    {
        return (static_cast<Fl_DerivedTable_Row *> (row))
            ->row_selected (rowIndex);
    }
