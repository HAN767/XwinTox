...
EXPORT
{
    ...
    FL_EXPORT_C (void *, Fl_Tree_user_data) (fl_Tree tree)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Tree *> (tree))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (fl_Window) (static_cast<Fl_Tree *> (tree))
    ...
    {
        return (fl_Tree_Item) (static_cast<Fl_Tree *> (tree))
            ->add ((static_cast<Fl_Tree_Item *> (item)), name);
    };
    FL_EXPORT_C(fl_Tree_Item,Fl_Tree_insert_above)(fl_Tree tree,fl_Tree_Item above,const char *name)
    {
        return (static_cast<Fl_Tree *> (tree))
            ->insert_above ((static_cast<Fl_Tree_Item *> (above)), name);
    }
    FL_EXPORT_C (int, Fl_Tree_remove) (fl_Tree tree, fl_Tree_Item item)
    {
        return (static_cast<Fl_Tree *> (tree))
            ->remove ((static_cast<Fl_Tree_Item *> (item)));
    }
    ...
    {
        return (static_cast<Fl_Tree *> (tree))
            ->clear_children ((static_cast<Fl_Tree_Item *> (item)));
    }
    ...
    {
        return (static_cast<Fl_Tree *> (tree))
            ->item_pathname (pathname, pathnamelen,
                             (static_cast<Fl_Tree_Item *> (item)));
    }
    ...
    {
        return (static_cast<Fl_Tree *> (tree))
            ->next ((static_cast<Fl_Tree_Item *> (item)));
    }
    ...
    {
        return (static_cast<Fl_Tree *> (tree))
            ->prev ((static_cast<Fl_Tree_Item *> (item)));
    }
    ...
    {
        return (static_cast<Fl_Tree *> (tree))
            ->is_open ((static_cast<Fl_Tree_Item *> (item)));
    }
    ...
    {
        return (static_cast<Fl_Tree *> (tree))
            ->is_close ((static_cast<Fl_Tree_Item *> (item)));
    }
    ...
    {
        return (static_cast<Fl_Tree *> (tree))
            ->is_selected ((static_cast<Fl_Tree_Item *> (item)));
    }
    ...
    {
        return (static_cast<Fl_Tree *> (tree))
            ->usericon ((static_cast<Fl_Image *> (val)));
    }
    ...
    {
        return (static_cast<Fl_Tree *> (tree))
            ->openicon ((static_cast<Fl_Image *> (val)));
    }
    ...
    {
        (static_cast<Fl_Tree *> (tree))
            ->closeicon ((static_cast<Fl_Image *> (val)));
    }
    ...
    {
        (static_cast<Fl_Tree *> (tree))
            ->load (*(static_cast<Fl_Preferences *> (preferences)));
    }
    FL_EXPORT_C (int, Fl_Tree_is_scrollbar) (fl_Tree tree, fl_Widget w)
    {
        return (static_cast<Fl_Tree *> (tree))
            ->is_scrollbar ((static_cast<Fl_Widget *> (w)));
    }
    ...
    {
        (static_cast<Fl_Tree *> (tree))
            ->callback_item ((static_cast<Fl_Tree_Item *> (item)));
    }
