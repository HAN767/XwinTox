...
EXPORT
{
    ...
    {
        return (fl_Group) (static_cast<Fl_File_Browser *> (file_browser))
            ->parent ();
    }
    FL_EXPORT_C(void,Fl_File_Browser_set_parent)(fl_File_Browser file_browser,fl_Group grp)
    {
        (static_cast<Fl_File_Browser *> (file_browser))
    ...
    FL_EXPORT_C(void*,Fl_File_Browser_user_data)(fl_File_Browser file_browser)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_File_Browser *> (file_browser))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (fl_Window) (static_cast<Fl_File_Browser *> (file_browser))
            ->window ();
    }
    ...
    {
        return (fl_Gl_Window) (static_cast<Fl_File_Browser *> (file_browser))
            ->as_gl_window ();
    }
    ...
    FL_EXPORT_C(fl_File_Browser, Fl_File_Browser_New_WithLabel)(int x, int y, int w, int h, const char* label)
    {
        Fl_File_Browser * file_browser =
            new Fl_File_Browser (x, y, w, h, label);
        return (static_cast<fl_File_Browser> (file_browser));
    }
    ...
    {
        Fl_File_Browser::Fl_Line_Position p =
            (Fl_File_Browser::Fl_Line_Position)-1;
        switch (p)
        {
        case TOP:
        {
            p = Fl_File_Browser::TOP;
            break;
        }
        case BOTTOM:
        {
            p = Fl_File_Browser::BOTTOM;
            break;
        }
        case MIDDLE:
        {
            p = Fl_File_Browser::MIDDLE;
            break;
        }
        default:
        {
            p = (Fl_File_Browser::Fl_Line_Position)-1;
            break;
        }
        }
        return (static_cast<Fl_File_Browser *> (file_browser))
    ...
    {
        return (fl_Image) (static_cast<Fl_File_Browser *> (file_browser))
            ->icon (line);
    }
