...
EXPORT
{
    ...
    {
        return (fl_Menu_Item) (static_cast<Fl_Menu_Item *> (menu_item))
            ->next (step);
    }
    ...
    FL_EXPORT_C(void,Fl_Menu_Item_set_user_data)(fl_Menu_Item menu_item,void* v)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Menu_Item *> (menu_item))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (fl_Menu_Item) (static_cast<Fl_Menu_Item *> (menu_item))
            ->popup (X, Y, title, (static_cast<Fl_Menu_Item *> (picked)),
                     (static_cast<Fl_Menu_ *> (menu)));
    }
    ...
    {
        return (fl_Menu_Item) (static_cast<Fl_Menu_Item *> (menu_item))
            ->pulldown (X, Y, W, H, (static_cast<Fl_Menu_Item *> (picked)),
                        (static_cast<Fl_Menu_ *> (menu)),
                        (static_cast<Fl_Menu_Item *> (title)), menubar);
    }
    ...
    {
        return (fl_Menu_Item) (static_cast<Fl_Menu_Item *> (menu_item))
            ->find_shortcut (ip, require_alt ? true : false);
    }
    ...
    FL_EXPORT_C(int,Fl_Menu_Item_insert)(fl_Menu_Item menu_item,int index,char* name,int shortcut,fl_Callback* cb)
    {
        ...
        return callback_interceptor->menu_insert (
            (static_cast<Fl_Menu_Item *> (menu_item)), index, name, shortcut,
            0);
    }
