...
EXPORT
{
    ...
    {
        return (fl_Group) (static_cast<Fl_Value_Output *> (value_output))
            ->parent ();
    }
    FL_EXPORT_C(void,Fl_Value_Output_set_parent)(fl_Value_Output value_output,fl_Group grp)
    {
        (static_cast<Fl_Value_Output *> (value_output))
    ...
    FL_EXPORT_C(void*,Fl_Value_Output_user_data)(fl_Value_Output value_output)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Value_Output *> (value_output))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (fl_Window) (static_cast<Fl_Value_Output *> (value_output))
            ->window ();
    }
    ...
    {
        return (fl_Gl_Window) (static_cast<Fl_Value_Output *> (value_output))
            ->as_gl_window ();
    }
    ...
    FL_EXPORT_C(fl_Value_Output,  Fl_Value_Output_New_WithLabel)(int x, int y, int w, int h, const char* label)
    {
        Fl_Value_Output * value_output =
            new Fl_Value_Output (x, y, w, h, label);
        return (static_cast<fl_Value_Output> (value_output));
    }
