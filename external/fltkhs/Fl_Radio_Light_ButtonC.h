...
EXPORT
{
    ...
    FL_EXPORT_C(void,         Fl_Radio_Light_Button_draw_label_with_xywh_alignment)(fl_Radio_Light_Button radio_light_button, int x , int y , int w, int h, Fl_Align alignment);
