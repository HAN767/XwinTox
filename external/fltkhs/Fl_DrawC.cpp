...
{
#endif
    FL_EXPORT_C (void, flc_set_color) (Fl_Color c) { fl_color (c); }
    FL_EXPORT_C (void, flc_set_color_with_c) (int c) { fl_color (c); }
    FL_EXPORT_C (void, flc_set_color_with_rgb) (uchar r, uchar g, uchar b)
    {
        fl_color (r, g, b);
    }
    FL_EXPORT_C (Fl_Color, flc_color) (void) { return fl_color (); }
    FL_EXPORT_C (void, flc_push_clip) (int x, int y, int w, int h)
    {
        fl_push_clip (x, y, w, h);
    }
    FL_EXPORT_C (void, flc_push_no_clip) () { fl_push_no_clip (); }
    FL_EXPORT_C (void, flc_pop_clip) () { fl_pop_clip (); }
    ...
    FL_EXPORT_C (void, flc_point) (int x, int y) { fl_point (x, y); }
    ...
    FL_EXPORT_C (void, flc_push_matrix) () { fl_push_matrix (); }
    FL_EXPORT_C (void, flc_pop_matrix) () { fl_pop_matrix (); }
    FL_EXPORT_C (void, flc_scale_with_y) (double x, double y)
    {
        fl_scale (x, y);
    }
    FL_EXPORT_C (void, flc_scale) (double x) { fl_scale (x); }
    FL_EXPORT_C (void, flc_translate) (double x, double y)
    {
        fl_translate (x, y);
    }
    FL_EXPORT_C (void, flc_rotate) (double d) { fl_rotate (d); }
    FL_EXPORT_C(void,flc_mult_matrix)(double a,double b,double c,double d,double x,double y)
    {
        fl_mult_matrix (a, b, c, d, x, y);
    }
    FL_EXPORT_C (void, flc_begin_points) () { fl_begin_points (); }
    FL_EXPORT_C (void, flc_begin_line) () { fl_begin_line (); }
    FL_EXPORT_C (void, flc_begin_loop) () { fl_begin_loop (); }
    FL_EXPORT_C (void, flc_begin_polygon) () { fl_begin_polygon (); }
    FL_EXPORT_C (void, flc_vertex) (double x, double y) { fl_vertex (x, y); }
    ...
    FL_EXPORT_C (void, flc_end_points) () { fl_end_points (); }
    FL_EXPORT_C (void, flc_end_line) () { fl_end_line (); }
    FL_EXPORT_C (void, flc_end_loop) () { fl_end_loop (); }
    FL_EXPORT_C (void, flc_end_polygon) () { fl_end_polygon (); }
    FL_EXPORT_C (void, flc_begin_complex_polygon) ()
    {
        fl_begin_complex_polygon ();
    }
    FL_EXPORT_C (void, flc_gap) () { fl_gap (); }
    ...
    FL_EXPORT_C (Fl_Font, flc_font) () { return fl_font (); }
    FL_EXPORT_C (Fl_Fontsize, flc_size) () { return fl_size (); }
    FL_EXPORT_C (int, flc_height) () { return fl_height (); }
    FL_EXPORT_C (int, flc_set_height) (int font, int size)
    {
        return fl_height (font, size);
    }
    FL_EXPORT_C (int, flc_descent) () { return fl_descent (); }
    ...
    {
        fl_draw (str, x, y, w, h, align, (static_cast<Fl_Image *> (img)),
                 draw_symbols);
    }
    ...
    {
        fl_draw (str, x, y, w, h, align, callthis,
                 (static_cast<Fl_Image *> (img)), draw_symbols);
    }
    ...
    FL_EXPORT_C (void, flc_overlay_clear) () { fl_overlay_clear (); }
    ...
    FL_EXPORT_C (void, flc_cursor) (Fl_Cursor cursor) { fl_cursor (cursor); }
    ...
    FL_EXPORT_C (void, flc_reset_spot) () { fl_reset_spot (); }
