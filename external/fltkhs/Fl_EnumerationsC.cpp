...
EXPORT
{
    ...
    {
        return fl_define_FL_GTK_UP_BOX ();
    }
    FL_EXPORT_C (Fl_Boxtype, fl_define_FL_GLEAM_UP_BOXC) ()
    {
        return fl_define_FL_GLEAM_UP_BOX ();
    }
    ...
    {
        return FL_ALIGN_TOP | FL_ALIGN_LEFT;
    }
    FL_EXPORT_C (Fl_Align, FL_ALIGN_TOP_RIGHTC) ()
    {
        return FL_ALIGN_TOP | FL_ALIGN_RIGHT;
    }
    FL_EXPORT_C (Fl_Align, FL_ALIGN_BOTTOM_LEFTC) ()
    {
        return FL_ALIGN_BOTTOM | FL_ALIGN_LEFT;
    }
    FL_EXPORT_C (Fl_Align, FL_ALIGN_BOTTOM_RIGHTC) ()
    {
        return FL_ALIGN_BOTTOM | FL_ALIGN_RIGHT;
    }
