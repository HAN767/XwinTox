...
EXPORT
{
    ...
    {
        return (fl_Group) (static_cast<Fl_Text_Display *> (text_display))
            ->parent ();
    }
    FL_EXPORT_C(void,Fl_Text_Display_set_parent)(fl_Text_Display text_display,fl_Text_Display grp)
    {
        (static_cast<Fl_Text_Display *> (text_display))
            ->parent ((static_cast<Fl_Text_Display *> (grp)));
    }
    ...
    {
        return (static_cast<Fl_Text_Display *> (text_display))
            ->selection_color ();
    }
    ...
    FL_EXPORT_C(void*,Fl_Text_Display_user_data)(fl_Text_Display text_display)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Text_Display *> (text_display))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (fl_Window) (static_cast<Fl_Text_Display *> (text_display))
            ->window ();
    }
    ...
    {
        return (fl_Text_Display) (static_cast<Fl_Text_Display *> (text_display))
            ->as_group ();
    }
    FL_EXPORT_C(fl_Gl_Window,Fl_Text_Display_as_gl_window)(fl_Text_Display text_display)
    {
        return (fl_Gl_Window) (static_cast<Fl_Text_Display *> (text_display))
            ->as_gl_window ();
    }
    ...
    {
        return (fl_Widget) (static_cast<Fl_Text_Display *> (text_display))
            ->resizable ();
    }
    ...
    // FL_EXPORT_C(int ,Fl_Text_Display_cursor_style)(fl_Text_Display
    // text_display){
    ...
    {
        Fl_Text_Display::Style_Table_Entry * s =
            new Fl_Text_Display::Style_Table_Entry[nStyles]();
        int i = 0;
        for (; i < nStyles; i++)
        {
            Fl_Text_Display::Style_Table_Entry x =
