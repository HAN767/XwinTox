...
EXPORT
{
    ...
    {
        return (static_cast<Fl_Text_Buffer *> (text_buffer))
    ...
    {
        (static_cast<Fl_Text_Buffer *> (text_buffer))
    ...
    {
        (static_cast<Fl_Text_Buffer *> (text_buffer))
            ->copy ((static_cast<Fl_Text_Buffer *> (fromBuf)), fromStart,
                    fromEnd, toPos);
    }
    ...
    {
        return (static_cast<Fl_Text_Buffer *> (text_buffer))
            ->outputfile (file, start, end, buflen);
    }
    ...
    {
        return (static_cast<Fl_Text_Buffer *> (text_buffer))
            ->secondary_selection_position (start, end);
    }
    ...
    {
        (static_cast<Fl_Text_Buffer *> (text_buffer))
            ->add_predelete_callback (bufPredelCB, cbArg);
    }
    ...
    {
        (static_cast<Fl_Text_Buffer *> (text_buffer))
            ->remove_predelete_callback (predelCB, cbArg);
    }
    ...
    {
        return (static_cast<Fl_Text_Buffer *> (text_buffer))
            ->findchar_forward (startPos, searchChar, foundPos);
    }
    ...
    {
        return (static_cast<Fl_Text_Buffer *> (text_buffer))
            ->findchar_backward (startPos, searchChar, foundPos);
    }
    ...
    {
        return (static_cast<Fl_Text_Buffer *> (text_buffer))
            ->search_forward (startPos, searchString, foundPos);
    }
    ...
    {
        return (static_cast<Fl_Text_Buffer *> (text_buffer))
            ->search_forward (startPos, searchString, foundPos, matchCase);
    }
    ...
    {
        return (static_cast<Fl_Text_Buffer *> (text_buffer))
            ->search_backward (startPos, searchString, foundPos);
    }
    ...
    {
        return (static_cast<Fl_Text_Buffer *> (text_buffer))
            ->search_backward (startPos, searchString, foundPos, matchCase);
    }
    FL_EXPORT_C(fl_Text_Selection,Fl_Text_Buffer_primary_selection)(fl_Text_Buffer text_buffer)
    {
        return (fl_Text_Selection) (static_cast<Fl_Text_Buffer *> (text_buffer))
            ->primary_selection ();
    }
    ...
    {
        Fl_Text_Buffer * b =
            new Fl_Text_Buffer (requestedSize, preferredGapSize);
        return (fl_Text_Buffer)b;
    }
