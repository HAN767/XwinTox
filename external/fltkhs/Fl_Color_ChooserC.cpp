...
EXPORT
{
    ...
    {
        return (static_cast<Fl_Color_Chooser *> (color_chooser))
            ->handle (event);
    }
    FL_EXPORT_C(fl_Group,Fl_Color_Chooser_parent)(fl_Color_Chooser color_chooser)
    {
        return (fl_Group) (static_cast<Fl_Color_Chooser *> (color_chooser))
            ->parent ();
    }
    FL_EXPORT_C(void,Fl_Color_Chooser_set_parent)(fl_Color_Chooser color_chooser,fl_Group grp)
    {
        (static_cast<Fl_Color_Chooser *> (color_chooser))
            ->parent ((static_cast<Fl_Color_Chooser *> (grp)));
    }
    ...
    FL_EXPORT_C(void*,Fl_Color_Chooser_user_data)(fl_Color_Chooser color_chooser)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Color_Chooser *> (color_chooser))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (fl_Window) (static_cast<Fl_Color_Chooser *> (color_chooser))
            ->window ();
    }
    ...
    {
        return (fl_Gl_Window) (static_cast<Fl_Color_Chooser *> (color_chooser))
            ->as_gl_window ();
    }
    ...
    {
        return (fl_Widget) (static_cast<Fl_Color_Chooser *> (color_chooser))
            ->resizable ();
    }
