...
#ifdef __cplusplus
Fl_DerivedButton::Fl_DerivedButton (int X, int Y, int W, int H, const char * l,
                                    fl_Button_Virtual_Funcs * funcs)
    : Fl_Button (X, Y, W, H, l)
{
    overriddenFuncs = funcs;
    other_data      = 0;
}
Fl_DerivedButton::Fl_DerivedButton (int X, int Y, int W, int H,
                                    fl_Button_Virtual_Funcs * funcs)
    : Fl_Button (X, Y, W, H, 0)
{
    overriddenFuncs = funcs;
...
void * Fl_DerivedButton::get_other_data () { return this->other_data; }
void Fl_DerivedButton::set_other_data (void * data) { this->other_data = data; }
...
void Fl_DerivedButton::draw_box () { Fl_Button::draw_box (); }
void Fl_DerivedButton::draw_box (Fl_Boxtype t, Fl_Color c)
{
    Fl_Button::draw_box (t, c);
}
void Fl_DerivedButton::draw_box (Fl_Boxtype t, int x, int y, int w, int h,
                                 Fl_Color c)
{
    Fl_Button::draw_box (t, x, y, w, h, c);
}
void Fl_DerivedButton::draw_backdrop () { Fl_Button::draw_backdrop (); }
void Fl_DerivedButton::draw_focus () { Fl_Button::draw_focus (); }
void Fl_DerivedButton::draw_focus (Fl_Boxtype t, int x, int y, int w, int h)
{
    Fl_Button::draw_focus (t, x, y, w, h);
}
void Fl_DerivedButton::draw_label () { Fl_Button::draw_label (); }
void Fl_DerivedButton::draw_label (int x, int y, int w, int h,
                                   Fl_Align alignment)
{
...
void Fl_DerivedButton::draw_super () { Fl_Button::draw (); }
...
Fl_Window * Fl_DerivedButton::as_window ()
{
    ...
    if (this->overriddenFuncs->as_window != NULL)
    {
        win = (static_cast<Fl_Window *> (
            this->overriddenFuncs->as_window ((fl_Button) this)));
    }
    else
    {
...
Fl_Gl_Window * Fl_DerivedButton::as_gl_window ()
{
    ...
    if (this->overriddenFuncs->as_gl_window != NULL)
    {
        win = (static_cast<Fl_Gl_Window *> (
            this->overriddenFuncs->as_gl_window ((fl_Button) this)));
    }
    else
    {
...
EXPORT
{
    ...
    {
        fl_Button_Virtual_Funcs * ptr = (fl_Button_Virtual_Funcs *)malloc (
            sizeof (fl_Button_Virtual_Funcs));
        ptr->draw         = NULL;
        ptr->handle       = NULL;
        ptr->resize       = NULL;
        ptr->show         = NULL;
    ...
    {
        return (fl_Gl_Window) (static_cast<Fl_Button *> (button))
            ->as_gl_window ();
    }
    FL_EXPORT_C (fl_Gl_Window, Fl_Button_as_gl_window) (fl_Button button)
    {
        return (fl_Gl_Window) (static_cast<Fl_DerivedButton *> (button))
            ->as_gl_window ();
    };
    ...
    {
        (static_cast<Fl_DerivedButton *> (b))
    ...
    FL_EXPORT_C (void *, Fl_Button_user_data) (fl_Button b)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_DerivedButton *> (b))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Button *> (b))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (static_cast<Fl_DerivedButton *> (b))
    ...
    {
        return (fl_Window) (static_cast<Fl_DerivedButton *> (button))
            ->window ();
    }
    ...
    {
        return (fl_Group) (static_cast<Fl_DerivedButton *> (button))
            ->as_group ();
    }
    ...
    FL_EXPORT_C(fl_Button, Fl_Button_New_WithLabel)(int x, int y, int w, int h, const char* label)
    {
        ...
        Fl_DerivedButton * button =
            new Fl_DerivedButton (x, y, w, h, label, funcs);
