...
{
#endif
    FL_EXPORT_C (float, Fl_Tooltip_delay) () { return Fl_Tooltip::delay (); }
    ...
    FL_EXPORT_C (void, Fl_Tooltip_enable) () { Fl_Tooltip::enable (); }
    FL_EXPORT_C (void, Fl_Tooltip_enable_with_b) (int b)
    {
        Fl_Tooltip::enable (b);
    }
    FL_EXPORT_C (void, Fl_Tooltip_disable) () { Fl_Tooltip::disable (); }
    FL_EXPORT_C(void,Fl_Tooltip_enter_area)(fl_Widget w,int X,int Y,int W,int H,const char* tip)
    {
        Fl_Tooltip::enter_area ((static_cast<Fl_Widget *> (w)), X, Y, W, H,
                                tip);
    }
    ...
    FL_EXPORT_C (Fl_Font, Fl_Tooltip_font) () { return Fl_Tooltip::font (); }
    ...
    FL_EXPORT_C (Fl_Color, Fl_Tooltip_color) () { return Fl_Tooltip::color (); }
