...
{
#endif
    FL_EXPORT_C (void, flc_gl_start) () { gl_start (); }
    FL_EXPORT_C (void, flc_gl_finish) () { gl_finish (); }
    FL_EXPORT_C (void, flc_gl_color) (Fl_Color i) { gl_color (i); }
    FL_EXPORT_C (void, flc_gl_color_with_i) (int c) { gl_color (c); }
    ...
    FL_EXPORT_C (int, flc_gl_height) () { return gl_height (); }
    FL_EXPORT_C (int, flc_gl_descent) () { return gl_descent (); }
    ...
    FL_EXPORT_C (void, flc_gl_draw) (const char * str) { gl_draw (str); }
