...
EXPORT
{
    ...
    {
        return (fl_Group) (static_cast<Fl_Secret_Input *> (secret_input))
            ->parent ();
    }
    FL_EXPORT_C(void,Fl_Secret_Input_set_parent)(fl_Secret_Input secret_input,fl_Group grp)
    {
        (static_cast<Fl_Secret_Input *> (secret_input))
    ...
    {
        Fl_Secret_Input * castedInput_dow =
            (static_cast<Fl_Secret_Input *> (secret_input));
    ...
    FL_EXPORT_C(void*,Fl_Secret_Input_user_data)(fl_Secret_Input secret_input)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Secret_Input *> (secret_input))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (fl_Window) (static_cast<Fl_Secret_Input *> (secret_input))
            ->window ();
    }
    ...
    {
        return (fl_Gl_Window) (static_cast<Fl_Secret_Input *> (secret_input))
            ->as_gl_window ();
    }
    ...
    FL_EXPORT_C(fl_Secret_Input, Fl_Secret_Input_New_WithLabel)(int x, int y, int w, int h, const char* label)
    {
        Fl_Secret_Input * secret_input =
            new Fl_Secret_Input (x, y, w, h, label);
        return (static_cast<fl_Secret_Input> (secret_input));
    }
