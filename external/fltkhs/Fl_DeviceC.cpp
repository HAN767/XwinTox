...
EXPORT
{
    ...
    {
        return (static_cast<Fl_Graphics_Driver *> (graphics_driver))
            ->class_name ();
    }
    ...
    {
        Fl_Font_Descriptor * _d =
            (static_cast<Fl_Graphics_Driver *> (graphics_driver))
                ->font_descriptor ();
    ...
    {
        return (static_cast<Fl_Surface_Device *> (surface_device))
            ->class_name ();
    }
    ...
    FL_EXPORT_C(fl_Graphics_Driver,Fl_Surface_Device_driver)(fl_Surface_Device surface_device)
    {
        return (fl_Graphics_Driver) (
                   static_cast<Fl_Surface_Device *> (surface_device))
            ->driver ();
    }
