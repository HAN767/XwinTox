...
EXPORT
{
    ...
    {
        return (fl_Group) (static_cast<Fl_Float_Input *> (float_input))
            ->parent ();
    }
    FL_EXPORT_C(void,Fl_Float_Input_set_parent)(fl_Float_Input float_input,fl_Group grp)
    {
        (static_cast<Fl_Float_Input *> (float_input))
    ...
    {
        return (static_cast<Fl_Float_Input *> (float_input))
            ->selection_color ();
    }
    ...
    {
        Fl_Float_Input * castedInput_dow =
            (static_cast<Fl_Float_Input *> (float_input));
    ...
    FL_EXPORT_C (void *, Fl_Float_Input_user_data) (fl_Float_Input float_input)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Float_Input *> (float_input))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (fl_Window) (static_cast<Fl_Float_Input *> (float_input))
            ->window ();
    }
    ...
    {
        return (fl_Gl_Window) (static_cast<Fl_Float_Input *> (float_input))
            ->as_gl_window ();
    }
