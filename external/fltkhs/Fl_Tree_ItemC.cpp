...
EXPORT
{
    ...
    {
        (static_cast<Fl_Tree_Item *> (tree_item))
            ->draw (X, *Y, W, (static_cast<Fl_Widget *> (tree)),
                    (static_cast<Fl_Tree_Item *> (itemfocus)),
                    (*(static_cast<Fl_Tree_Prefs *> (prefs))));
    }
    ...
    FL_EXPORT_C(void,Fl_Tree_Item_set_user_data)(fl_Tree_Item tree_item,void* data)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Tree_Item *> (tree_item))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        (static_cast<Fl_Tree_Item *> (tree_item))
            ->widget ((static_cast<Fl_Widget *> (val)));
    }
    ...
    {
        return (fl_Tree_Item) (static_cast<Fl_Tree_Item *> (tree_item))
            ->child (index);
    }
    ...
    FL_EXPORT_C(fl_Tree_Item, Fl_Tree_Item_add_with)(fl_Tree_Item tree_item,  const fl_Tree_Prefs prefs,  const char* new_label, fl_Tree_Item new_item)
    {
        ...
        return (static_cast<Fl_Tree_Item *> (tree_item))
            ->add ((static_cast<Fl_Tree_Prefs &> (*casted)), new_label,
                   (static_cast<Fl_Tree_Item *> (new_item)));
    }
    FL_EXPORT_C(fl_Tree_Item, Fl_Tree_Item_add_with_at)(fl_Tree_Item tree_item,  fl_Tree_Prefs prefs, fl_Tree_Item new_item, char** arr)
    {
        Fl_Tree_Prefs * casted = static_cast<Fl_Tree_Prefs *> (prefs);
        return (fl_Tree_Item) (static_cast<Fl_Tree_Item *> (tree_item))
            ->add ((static_cast<Fl_Tree_Prefs &> (*casted)), arr,
                   (static_cast<Fl_Tree_Item *> (new_item)));
    }
    ...
    {
        return (static_cast<Fl_Tree_Item *> (tree_item))
            ->swap_children ((static_cast<Fl_Tree_Item *> (a)),
                             (static_cast<Fl_Tree_Item *> (b)));
    }
    ...
    {
        return (static_cast<Fl_Tree_Item *> (tree_item))
            ->reparent ((static_cast<Fl_Tree_Item *> (new_item)), index);
    }
    ...
    {
        return (static_cast<Fl_Tree_Item *> (tree_item))
            ->parent ((static_cast<Fl_Tree_Item *> (val)));
    }
    ...
    FL_EXPORT_C(fl_Tree_Item, Fl_Tree_Item_insert_above)(fl_Tree_Item tree_item,  fl_Tree_Prefs prefs,  char *new_label)
    {
        Fl_Tree_Prefs * casted = static_cast<Fl_Tree_Prefs *> (prefs);
        return (static_cast<Fl_Tree_Item *> (tree_item))
            ->insert_above ((static_cast<Fl_Tree_Prefs &> (*casted)),
                            new_label);
    }
