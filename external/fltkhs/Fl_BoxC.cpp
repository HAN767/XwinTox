#include "Fl_BoxC.h"
#ifdef __cplusplus
Fl_DerivedBox::Fl_DerivedBox (int X, int Y, int W, int H, const char * l,
                              fl_Box_Virtual_Funcs * funcs)
    : Fl_Box (X, Y, W, H, l)
{
    overriddenFuncs = funcs;
    other_data      = 0;
}
Fl_DerivedBox::Fl_DerivedBox (int X, int Y, int W, int H,
                              fl_Box_Virtual_Funcs * funcs)
    : Fl_Box (X, Y, W, H, 0)
{
    overriddenFuncs = funcs;
...
Fl_DerivedBox::Fl_DerivedBox (Fl_Boxtype b, int X, int Y, int W, int H,
                              const char * l, fl_Box_Virtual_Funcs * funcs)
    : Fl_Box (b, X, Y, W, H, l)
{
    overriddenFuncs = funcs;
    other_data      = 0;
...
void * Fl_DerivedBox::get_other_data () { return this->other_data; }
void Fl_DerivedBox::set_other_data (void * data) { this->other_data = data; }
...
void Fl_DerivedBox::draw_box () { Fl_Box::draw_box (); }
void Fl_DerivedBox::draw_box (Fl_Boxtype t, Fl_Color c)
{
    Fl_Box::draw_box (t, c);
}
void Fl_DerivedBox::draw_box (Fl_Boxtype t, int x, int y, int w, int h,
                              Fl_Color c)
{
    Fl_Box::draw_box (t, x, y, w, h, c);
}
void Fl_DerivedBox::draw_backdrop () { Fl_Box::draw_backdrop (); }
void Fl_DerivedBox::draw_focus () { Fl_Box::draw_focus (); }
void Fl_DerivedBox::draw_focus (Fl_Boxtype t, int x, int y, int w, int h)
{
    Fl_Box::draw_focus (t, x, y, w, h);
}
void Fl_DerivedBox::draw_label () { Fl_Box::draw_label (); }
...
void Fl_DerivedBox::draw_super () { Fl_Box::draw (); }
...
EXPORT
{
    ...
    {
#endif
        fl_Box_Virtual_Funcs * ptr =
            (fl_Box_Virtual_Funcs *)malloc (sizeof (fl_Box_Virtual_Funcs));
        ptr->draw         = NULL;
        ptr->handle       = NULL;
        ptr->resize       = NULL;
        ptr->show         = NULL;
    ...
    {
        return (fl_Gl_Window) (static_cast<Fl_DerivedBox *> (box))
            ->Fl_Box::as_gl_window ();
    }
    ...
    FL_EXPORT_C (void *, Fl_Box_user_data) (fl_Box box)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_DerivedBox *> (box))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Box *> (box))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (static_cast<Fl_DerivedBox *> (box))
