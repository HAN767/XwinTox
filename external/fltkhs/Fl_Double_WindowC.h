...
EXPORT
{
    ...
    /* FL_EXPORT_C(void,         Fl_Double_Window_forms_end)(fl_Double_Window
     * win); */
    /* Fl_Window inherited */
...
// flush resize destructor, constructor
    ...
    class Fl_DerivedDouble_Window : public Fl_Double_Window
    {
      ...
      public:
        ...
        int * sizes ();
        Fl_DerivedDouble_Window (int X, int Y, int W, int H, const char * l,
                                 fl_Double_Window_Virtual_Funcs * funcs);
        Fl_DerivedDouble_Window (int X, int Y, int W, int H,
                                 fl_Double_Window_Virtual_Funcs * funcs);
        Fl_DerivedDouble_Window (int W, int H, const char * l,
                                 fl_Double_Window_Virtual_Funcs * funcs);
        Fl_DerivedDouble_Window (int W, int H,
                                 fl_Double_Window_Virtual_Funcs * funcs);
