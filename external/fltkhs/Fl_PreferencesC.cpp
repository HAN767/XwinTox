...
EXPORT
{
    ...
    FL_EXPORT_C(fl_Preferences, Fl_Preferences_With_Root)( Root root, const char* vendor, const char* application )
    {
        ...
        {
            preferences =
                new Fl_Preferences (Fl_Preferences::USER, vendor, application);
        }
        else
        {
            preferences = new Fl_Preferences (Fl_Preferences::SYSTEM, vendor,
                                              application);
        }
    ...
    {
        return (static_cast<Fl_Preferences *> (preferences))
            ->deleteGroup (group);
    }
    ...
    {
        return (static_cast<Fl_Preferences *> (preferences))
            ->get (entry, value, defaultValue, maxSize);
    }
    ...
    {
        return (static_cast<Fl_Preferences *> (preferences))
            ->get (entry, value, defaultValue, defaultSize);
    }
    ...
    {
        return (static_cast<Fl_Preferences *> (preferences))
            ->get (entry, value, defaultValue, defaultSize, maxSize);
    }
