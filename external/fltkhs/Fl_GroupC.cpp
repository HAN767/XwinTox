...
void Fl_DerivedGroup::draw_children () { Fl_Group::draw_children (); }
...
EXPORT
{
    ...
    {
        (static_cast<Fl_DerivedGroup *> (win))
    ...
    FL_EXPORT_C (void *, Fl_Group_user_data) (fl_Group win)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_DerivedGroup *> (win))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (static_cast<Fl_DerivedGroup *> (win))
    ...
    {
        return (fl_Window) (static_cast<Fl_DerivedGroup *> (group))
            ->top_window ();
    }
    ...
    {
        return (fl_Gl_Window) (static_cast<Fl_DerivedGroup *> (win))
            ->as_gl_window ();
    }
    FL_EXPORT_C (void, Fl_Group_draw_child) (fl_Group group, fl_Widget widget)
    {
        (static_cast<Fl_DerivedGroup *> (group))
    ...
    {
        (static_cast<Fl_DerivedGroup *> (self))
