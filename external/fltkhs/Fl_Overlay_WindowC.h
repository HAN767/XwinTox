...
EXPORT
{
    class Fl_DerivedOverlay_Window : public Fl_Overlay_Window
    {
      ...
      public:
        void draw_overlay ();
        Fl_DerivedOverlay_Window (int X, int Y, int W, int H, const char * l,
                                  void (*can_draw_fp) (fl_Overlay_Window));
        Fl_DerivedOverlay_Window (int X, int Y, int W, int H,
                                  void (*can_draw_fp) (fl_Overlay_Window));
        Fl_DerivedOverlay_Window (int W, int H, const char * l,
                                  void (*can_draw_fp) (fl_Overlay_Window));
        Fl_DerivedOverlay_Window (int W, int H,
                                  void (*can_draw_fp) (fl_Overlay_Window));
    };
#endif
    ...
    /* FL_EXPORT_C(void,         Fl_Overlay_Window_forms_end)(fl_Overlay_Window
     * win); */
    /* Fl_Window inherited */
