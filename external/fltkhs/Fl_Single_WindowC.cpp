...
Fl_DerivedSingle_Window::Fl_DerivedSingle_Window (
    int X, int Y, int W, int H, const char * l, fl_Window_Virtual_Funcs * funcs)
...
Fl_DerivedSingle_Window::Fl_DerivedSingle_Window (
    int X, int Y, int W, int H, fl_Window_Virtual_Funcs * funcs)
    : Fl_Single_Window (X, Y, W, H, 0)
{
    overriddenFuncs = funcs;
    other_data      = 0;
}
Fl_DerivedSingle_Window::Fl_DerivedSingle_Window (
    int W, int H, const char * l, fl_Window_Virtual_Funcs * funcs)
...
Fl_DerivedSingle_Window::Fl_DerivedSingle_Window (
    int W, int H, fl_Window_Virtual_Funcs * funcs)
    : Fl_Single_Window (W, H, 0)
{
    overriddenFuncs = funcs;
    other_data      = 0;
}
...
void * Fl_DerivedSingle_Window::get_other_data () { return this->other_data; }
...
void Fl_DerivedSingle_Window::draw_box () { Fl_Single_Window::draw_box (); }
void Fl_DerivedSingle_Window::draw_box (Fl_Boxtype t, Fl_Color c)
{
    Fl_Single_Window::draw_box (t, c);
}
void Fl_DerivedSingle_Window::draw_box (Fl_Boxtype t, int x, int y, int w,
                                        int h, Fl_Color c)
{
...
void Fl_DerivedSingle_Window::draw_focus () { Fl_Single_Window::draw_focus (); }
void Fl_DerivedSingle_Window::draw_focus (Fl_Boxtype t, int x, int y, int w,
                                          int h)
{
    Fl_Single_Window::draw_focus (t, x, y, w, h);
}
void Fl_DerivedSingle_Window::draw_label () { Fl_Single_Window::draw_label (); }
void Fl_DerivedSingle_Window::draw_label (int x, int y, int w, int h,
                                          Fl_Align alignment)
{
...
int * Fl_DerivedSingle_Window::sizes () { return Fl_Single_Window::sizes (); }
...
void Fl_DerivedSingle_Window::flush_super () { Fl_Single_Window::flush (); }
...
void Fl_DerivedSingle_Window::show_super () { Fl_Single_Window::show (); }
...
void Fl_DerivedSingle_Window::hide_super () { Fl_Single_Window::hide (); }
...
void Fl_DerivedSingle_Window::draw_super () { Fl_Single_Window::draw (); }
Fl_Window * Fl_DerivedSingle_Window::as_window ()
{
    ...
    if (this->overriddenFuncs->as_window != NULL)
    {
        win = (static_cast<Fl_Window *> (
            this->overriddenFuncs->as_window ((fl_Window) this)));
    }
    else
    {
...
Fl_Group * Fl_DerivedSingle_Window::as_group ()
{
    ...
    {
        grp = (static_cast<Fl_Window *> (
            this->overriddenFuncs->as_group ((fl_Window) this)));
    }
    else
    {
...
Fl_Gl_Window * Fl_DerivedSingle_Window::as_gl_window ()
{
    ...
    if (this->overriddenFuncs->as_gl_window != NULL)
    {
        win = (static_cast<Fl_Gl_Window *> (
            this->overriddenFuncs->as_gl_window ((fl_Window) this)));
    }
    else
    {
...
EXPORT
{
    ...
    {
        fl_Single_Window_Virtual_Funcs * ptr =
            (fl_Single_Window_Virtual_Funcs *)malloc (
                sizeof (fl_Single_Window_Virtual_Funcs));
        ptr->draw         = NULL;
        ptr->handle       = NULL;
        ptr->resize       = NULL;
        ptr->show         = NULL;
    ...
    {
        return (fl_Window) (static_cast<Fl_DerivedSingle_Window *> (self))
            ->as_window ();
    }
    ...
    {
        (static_cast<Fl_DerivedSingle_Window *> (double_window))
            ->align (alignment);
    }
    ...
    {
        return (static_cast<Fl_DerivedSingle_Window *> (win))
            ->selection_color ();
    }
    ...
    FL_EXPORT_C (void *, Fl_Single_Window_user_data) (fl_Single_Window win)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_DerivedSingle_Window *> (win))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (fl_Gl_Window) (static_cast<Fl_DerivedSingle_Window *> (win))
            ->as_gl_window ();
    }
    ...
    {
        (static_cast<Fl_DerivedSingle_Window *> (Single_Window))
            ->draw_child (static_cast<Fl_Widget *> (widget));
    }
    ...
    {
        return (fl_Widget) (static_cast<Fl_DerivedSingle_Window *> (win))
            ->resizable ();
    }
    ...
    {
        (static_cast<Fl_DerivedSingle_Window *> (self))
    ...
    {
        return (fl_Widget *)(static_cast<Fl_DerivedSingle_Window *> (self))
            ->array ();
    }
    ...
    FL_EXPORT_C(fl_Single_Window, Fl_Single_Window_New_WithLabel)(int w, int h, const char* title)
    {
        ...
        Fl_DerivedSingle_Window * window =
            new Fl_DerivedSingle_Window (w, h, title, funcs);
        return (static_cast<fl_Single_Window> (window));
    }
    FL_EXPORT_C (fl_Single_Window, Fl_Single_Window_New) (int w, int h)
    {
        fl_Single_Window_Virtual_Funcs * funcs =
            Fl_Single_Window_default_virtual_funcs ();
        Fl_DerivedSingle_Window * window =
            new Fl_DerivedSingle_Window (w, h, 0, funcs);
    ...
    FL_EXPORT_C(fl_Single_Window, Fl_Single_Window_NewXY_WithLabel)(int x, int y, int w, int h, const char* title)
    {
        fl_Single_Window_Virtual_Funcs * funcs =
            Fl_Single_Window_default_virtual_funcs ();
        Fl_DerivedSingle_Window * window =
            new Fl_DerivedSingle_Window (x, y, w, h, title, funcs);
        return (fl_Single_Window)window;
    }
    FL_EXPORT_C(fl_Single_Window, Fl_Single_Window_NewXY)(int x, int y, int w, int h)
    {
        fl_Single_Window_Virtual_Funcs * funcs =
            Fl_Single_Window_default_virtual_funcs ();
        Fl_DerivedSingle_Window * window =
            new Fl_DerivedSingle_Window (x, y, w, h, 0, funcs);
        return (fl_Single_Window)window;
    }
    ...
    {
        (static_cast<Fl_DerivedSingle_Window *> (win))
            ->size_range (minw, minh, ptr->maxw, ptr->maxh, ptr->dw, ptr->dh,
                          ptr->aspect);
    }
    ...
    {
        Fl_Single_Window::default_callback (
            (static_cast<Fl_DerivedSingle_Window *> (win)), v);
    }
#ifdef __cplusplus
}
#endif
