...
EXPORT
{
    ...
    {
        return (fl_Gl_Window) (static_cast<Fl_Scrollbar *> (slider))
            ->as_gl_window ();
    };
    ...
    {
        (static_cast<Fl_Scrollbar *> (slider))
    ...
    FL_EXPORT_C (void *, Fl_Scrollbar_user_data) (fl_Scrollbar slider)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Scrollbar *> (slider))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (fl_Window) (static_cast<Fl_Scrollbar *> (slider))
            ->top_window ();
    }
