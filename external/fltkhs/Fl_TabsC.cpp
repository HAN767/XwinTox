...
EXPORT
{
    ...
    FL_EXPORT_C (void *, Fl_Tabs_user_data) (fl_Tabs tabs)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Tabs *> (tabs))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (static_cast<Fl_Tabs *> (tabs))
    ...
    {
        return (fl_Window) (static_cast<Fl_Tabs *> (tabs))
    ...
    {
        return (static_cast<Fl_Tabs *> (tabs))
            ->push ((static_cast<Fl_Widget *> (w)));
    }
    FL_EXPORT_C(fl_Widget,Fl_Tabs_which)(fl_Tabs tabs,int event_x,int event_y)
    {
        return (fl_Widget) (static_cast<Fl_Tabs *> (tabs))
            ->which (event_x, event_y);
    }
