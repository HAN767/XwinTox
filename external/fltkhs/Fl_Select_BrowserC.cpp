...
EXPORT
{
    ...
    {
        return (fl_Group) (static_cast<Fl_Select_Browser *> (select_browser))
            ->parent ();
    }
    FL_EXPORT_C(void,Fl_Select_Browser_set_parent)(fl_Select_Browser select_browser,fl_Group grp)
    {
        (static_cast<Fl_Select_Browser *> (select_browser))
    ...
    {
        Fl_Select_Browser * castedWindow =
            (static_cast<Fl_Select_Browser *> (select_browser));
    ...
    FL_EXPORT_C(void*,Fl_Select_Browser_user_data)(fl_Select_Browser select_browser)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Select_Browser *> (select_browser))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (fl_Window) (static_cast<Fl_Select_Browser *> (select_browser))
            ->window ();
    }
    ...
    {
        Fl_Select_Browser::Fl_Line_Position p =
            (Fl_Select_Browser::Fl_Line_Position)-1;
        switch (p)
        {
        case TOP:
        {
            p = Fl_Select_Browser::TOP;
            break;
        }
        case BOTTOM:
        {
            p = Fl_Select_Browser::BOTTOM;
            break;
        }
        case MIDDLE:
        {
            p = Fl_Select_Browser::MIDDLE;
            break;
        }
        default:
        {
            p = (Fl_Select_Browser::Fl_Line_Position)-1;
            break;
        }
        }
        return (static_cast<Fl_Select_Browser *> (select_browser))
    ...
    {
        return (fl_Image) (static_cast<Fl_Select_Browser *> (select_browser))
            ->icon (line);
    }
