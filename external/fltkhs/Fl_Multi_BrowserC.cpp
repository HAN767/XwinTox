...
Fl_DerivedMulti_Browser::Fl_DerivedMulti_Browser (
    ...
    fl_Multi_Browser_Virtual_Funcs * funcs)
...
Fl_DerivedMulti_Browser::Fl_DerivedMulti_Browser (
    int X, int Y, int W, int H, fl_Multi_Browser_Virtual_Funcs * funcs)
    : Fl_Multi_Browser (X, Y, W, H, 0)
{
    overriddenFuncs = funcs;
    other_data      = (void *)0;
}
...
void * Fl_DerivedMulti_Browser::get_other_data () { return this->other_data; }
...
void Fl_DerivedMulti_Browser::draw_box () { Fl_Multi_Browser::draw_box (); }
void Fl_DerivedMulti_Browser::draw_box (Fl_Boxtype t, Fl_Color c)
{
    Fl_Multi_Browser::draw_box (t, c);
}
void Fl_DerivedMulti_Browser::draw_box (Fl_Boxtype t, int x, int y, int w,
                                        int h, Fl_Color c)
{
...
void Fl_DerivedMulti_Browser::draw_focus () { Fl_Multi_Browser::draw_focus (); }
void Fl_DerivedMulti_Browser::draw_focus (Fl_Boxtype t, int x, int y, int w,
                                          int h)
{
    Fl_Multi_Browser::draw_focus (t, x, y, w, h);
}
void Fl_DerivedMulti_Browser::draw_label () { Fl_Multi_Browser::draw_label (); }
void Fl_DerivedMulti_Browser::draw_label (int x, int y, int w, int h,
                                          Fl_Align alignment)
{
...
Fl_Group * Fl_DerivedMulti_Browser::as_group ()
{
    ...
    if (this->overriddenFuncs->as_group != NULL)
    {
        grp = (static_cast<Fl_Group *> (
            this->overriddenFuncs->as_group ((fl_Multi_Browser) this)));
    }
    else
    {
...
Fl_Window * Fl_DerivedMulti_Browser::as_window ()
{
    ...
    if (this->overriddenFuncs->as_window != NULL)
    {
        win = (static_cast<Fl_Window *> (
            this->overriddenFuncs->as_window ((fl_Multi_Browser) this)));
    }
    else
    {
...
Fl_Gl_Window * Fl_DerivedMulti_Browser::as_gl_window ()
{
    ...
    if (this->overriddenFuncs->as_gl_window != NULL)
    {
        win = (static_cast<Fl_Gl_Window *> (
            this->overriddenFuncs->as_gl_window ((fl_Multi_Browser) this)));
    }
    else
    {
...
EXPORT
{
    ...
    {
        fl_Multi_Browser_Virtual_Funcs * ptr =
            (fl_Multi_Browser_Virtual_Funcs *)malloc (
                sizeof (fl_Multi_Browser_Virtual_Funcs));
        ptr->draw           = NULL;
        ptr->handle         = NULL;
        ptr->resize         = NULL;
        ptr->show           = NULL;
    ...
    {
        return (fl_Group) (
                   static_cast<Fl_DerivedMulti_Browser *> (multi_browser))
            ->parent ();
    }
    ...
    {
        return (static_cast<Fl_DerivedMulti_Browser *> (multi_browser))
            ->type ();
    }
    ...
    {
        Fl_DerivedMulti_Browser * castedWindow =
            (static_cast<Fl_DerivedMulti_Browser *> (multi_browser));
    ...
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Multi_Browser *> (multi_browser))->user_data ()));
        if (stored_cb)
        {
            stored_cb->set_user_data (v);
            (static_cast<Fl_Multi_Browser *> (multi_browser))
                ->user_data (stored_cb);
        }
        else
        {
    ...
    {
        return (fl_Group) (static_cast<Fl_Multi_Browser *> (multi_browser))
            ->as_group ();
    }
    ...
    {
        return (fl_Gl_Window) (static_cast<Fl_Multi_Browser *> (multi_browser))
            ->as_gl_window ();
    }
    ...
    {
        fl_Multi_Browser_Virtual_Funcs * funcs =
            Fl_Multi_Browser_default_virtual_funcs ();
        Fl_DerivedMulti_Browser * multi_browser =
            new Fl_DerivedMulti_Browser (x, y, w, h, label, funcs);
    ...
    FL_EXPORT_C(fl_Multi_Browser, Fl_Multi_Browser_New)(int x, int y, int w, int h)
    {
        fl_Multi_Browser_Virtual_Funcs * funcs =
            Fl_Multi_Browser_default_virtual_funcs ();
        Fl_DerivedMulti_Browser * multi_browser =
            new Fl_DerivedMulti_Browser (x, y, w, h, 0, funcs);
    ...
    {
        Fl_Multi_Browser::Fl_Line_Position p =
            (Fl_Multi_Browser::Fl_Line_Position)-1;
        switch (p)
        {
        case TOP:
        {
            p = Fl_Multi_Browser::TOP;
            break;
        }
        case BOTTOM:
        {
            p = Fl_Multi_Browser::BOTTOM;
            break;
        }
        case MIDDLE:
        {
            p = Fl_Multi_Browser::MIDDLE;
            break;
        }
        default:
        {
            p = (Fl_Multi_Browser::Fl_Line_Position)-1;
            break;
        }
        }
        return (static_cast<Fl_DerivedMulti_Browser *> (multi_browser))
    ...
    {
        (static_cast<Fl_DerivedMulti_Browser *> (multi_browser))
            ->icon (line, (static_cast<Fl_Image *> (icon)));
    }
