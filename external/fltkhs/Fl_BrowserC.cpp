...
#ifdef __cplusplus
Fl_DerivedBrowser::Fl_DerivedBrowser (int X, int Y, int W, int H,
                                      const char * l,
                                      fl_Browser_Virtual_Funcs * funcs)
...
void * Fl_DerivedBrowser::get_other_data () { return this->other_data; }
...
void Fl_DerivedBrowser::draw_box () { Fl_Browser::draw_box (); }
void Fl_DerivedBrowser::draw_box (Fl_Boxtype t, Fl_Color c)
{
    Fl_Browser::draw_box (t, c);
}
void Fl_DerivedBrowser::draw_box (Fl_Boxtype t, int x, int y, int w, int h,
                                  Fl_Color c)
{
    Fl_Browser::draw_box (t, x, y, w, h, c);
}
void Fl_DerivedBrowser::draw_backdrop () { Fl_Browser::draw_backdrop (); }
void Fl_DerivedBrowser::draw_focus () { Fl_Browser::draw_focus (); }
void Fl_DerivedBrowser::draw_focus (Fl_Boxtype t, int x, int y, int w, int h)
{
    Fl_Browser::draw_focus (t, x, y, w, h);
}
void Fl_DerivedBrowser::draw_label () { Fl_Browser::draw_label (); }
void Fl_DerivedBrowser::draw_label (int x, int y, int w, int h,
                                    Fl_Align alignment)
{
...
Fl_Group * Fl_DerivedBrowser::as_group ()
{
    ...
    if (this->overriddenFuncs->as_group != NULL)
    {
        grp = (static_cast<Fl_Group *> (
            this->overriddenFuncs->as_group ((fl_Browser) this)));
    }
    else
    {
...
Fl_Window * Fl_DerivedBrowser::as_window ()
{
    ...
    if (this->overriddenFuncs->as_window != NULL)
    {
        win = (static_cast<Fl_Window *> (
            this->overriddenFuncs->as_window ((fl_Browser) this)));
    }
    else
    {
...
Fl_Gl_Window * Fl_DerivedBrowser::as_gl_window ()
{
    ...
    if (this->overriddenFuncs->as_gl_window != NULL)
    {
        win = (static_cast<Fl_Gl_Window *> (
            this->overriddenFuncs->as_gl_window ((fl_Browser) this)));
    }
    else
    {
...
EXPORT
{
    ...
    {
        fl_Browser_Virtual_Funcs * ptr = (fl_Browser_Virtual_Funcs *)malloc (
            sizeof (fl_Browser_Virtual_Funcs));
        ptr->draw           = NULL;
        ptr->handle         = NULL;
        ptr->resize         = NULL;
        ptr->show           = NULL;
    ...
    {
        return (fl_Group) (static_cast<Fl_DerivedBrowser *> (browser))
            ->parent ();
    }
    FL_EXPORT_C (void, Fl_Browser_set_parent) (fl_Browser browser, fl_Group grp)
    {
        (static_cast<Fl_DerivedBrowser *> (browser))
    ...
    {
        Fl_DerivedBrowser * castedWindow =
            (static_cast<Fl_DerivedBrowser *> (browser));
    ...
    FL_EXPORT_C (void *, Fl_Browser_user_data) (fl_Browser browser)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_DerivedBrowser *> (browser))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Browser *> (browser))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (static_cast<Fl_DerivedBrowser *> (browser))
    ...
    {
        return (fl_Window) (static_cast<Fl_DerivedBrowser *> (browser))
            ->window ();
    }
    ...
    {
        return (fl_Gl_Window) (static_cast<Fl_Browser *> (browser))
            ->as_gl_window ();
    }
    FL_EXPORT_C (fl_Gl_Window, Fl_Browser_as_gl_window) (fl_Browser browser)
    {
        return (fl_Gl_Window) (static_cast<Fl_DerivedBrowser *> (browser))
            ->as_gl_window ();
    }
    ...
    FL_EXPORT_C(fl_Browser, Fl_Browser_New_WithLabel)(int x, int y, int w, int h, const char* label)
    {
        ...
        Fl_DerivedBrowser * browser =
            new Fl_DerivedBrowser (x, y, w, h, label, funcs);
    ...
    FL_EXPORT_C (fl_Browser, Fl_Browser_New) (int x, int y, int w, int h)
    {
        fl_Browser_Virtual_Funcs * funcs = Fl_Browser_default_virtual_funcs ();
        Fl_DerivedBrowser * browser =
            new Fl_DerivedBrowser (x, y, w, h, 0, funcs);
    ...
    FL_EXPORT_C(void,Fl_Browser_lineposition)(fl_Browser browser,int line,Fl_Line_Position pos)
    {
        ...
        default:
        {
            p = (Fl_Browser::Fl_Line_Position)-1;
            break;
        }
        }
        return (static_cast<Fl_DerivedBrowser *> (browser))
    ...
    {
        return (fl_Image) (static_cast<Fl_DerivedBrowser *> (browser))
            ->icon (line);
    }
