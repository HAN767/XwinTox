...
void * Fl_DerivedDouble_Window::get_other_data () { return this->other_data; }
...
void Fl_DerivedDouble_Window::draw_box () { Fl_Double_Window::draw_box (); }
void Fl_DerivedDouble_Window::draw_box (Fl_Boxtype t, Fl_Color c)
{
    Fl_Double_Window::draw_box (t, c);
}
void Fl_DerivedDouble_Window::draw_box (Fl_Boxtype t, int x, int y, int w,
                                        int h, Fl_Color c)
{
...
void Fl_DerivedDouble_Window::draw_focus () { Fl_Double_Window::draw_focus (); }
void Fl_DerivedDouble_Window::draw_focus (Fl_Boxtype t, int x, int y, int w,
                                          int h)
{
    Fl_Double_Window::draw_focus (t, x, y, w, h);
}
void Fl_DerivedDouble_Window::draw_label () { Fl_Double_Window::draw_label (); }
void Fl_DerivedDouble_Window::draw_label (int x, int y, int w, int h,
                                          Fl_Align alignment)
{
...
int * Fl_DerivedDouble_Window::sizes () { return Fl_Double_Window::sizes (); }
...
void Fl_DerivedDouble_Window::flush_super () { Fl_Double_Window::flush (); }
...
void Fl_DerivedDouble_Window::show_super () { Fl_Double_Window::show (); }
...
void Fl_DerivedDouble_Window::hide_super () { Fl_Double_Window::hide (); }
...
void Fl_DerivedDouble_Window::draw_super () { Fl_Double_Window::draw (); }
...
EXPORT
{
    ...
    {
        fl_Double_Window_Virtual_Funcs * ptr =
            (fl_Double_Window_Virtual_Funcs *)malloc (
                sizeof (fl_Double_Window_Virtual_Funcs));
        ptr->draw         = NULL;
        ptr->handle       = NULL;
        ptr->resize       = NULL;
        ptr->show         = NULL;
    ...
    {
        return (fl_Window) (static_cast<Fl_DerivedDouble_Window *> (self))
            ->as_window ();
    }
    ...
    {
        (static_cast<Fl_DerivedDouble_Window *> (double_window))
            ->align (alignment);
    }
    ...
    {
        return (static_cast<Fl_DerivedDouble_Window *> (win))
            ->selection_color ();
    }
    ...
    FL_EXPORT_C (void *, Fl_Double_Window_user_data) (fl_Double_Window win)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_DerivedDouble_Window *> (win))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (fl_Gl_Window) (static_cast<Fl_DerivedDouble_Window *> (win))
            ->as_gl_window ();
    }
    ...
    {
        return (static_cast<Fl_DerivedDouble_Window *> (Double_Window))
            ->sizes ();
    }
    ...
    {
        return (fl_Widget) (static_cast<Fl_DerivedDouble_Window *> (win))
            ->resizable ();
    }
    ...
    {
        (static_cast<Fl_DerivedDouble_Window *> (self))
    ...
    {
        return (fl_Widget *)(static_cast<Fl_DerivedDouble_Window *> (self))
            ->array ();
    }
    ...
    FL_EXPORT_C(fl_Double_Window, Fl_Double_Window_New_WithLabel)(int w, int h, const char* title)
    {
        ...
        Fl_DerivedDouble_Window * window =
            new Fl_DerivedDouble_Window (w, h, title, funcs);
        return (static_cast<fl_Double_Window> (window));
    }
    FL_EXPORT_C (fl_Double_Window, Fl_Double_Window_New) (int w, int h)
    {
        fl_Double_Window_Virtual_Funcs * funcs =
            Fl_Double_Window_default_virtual_funcs ();
        Fl_DerivedDouble_Window * window =
            new Fl_DerivedDouble_Window (w, h, 0, funcs);
    ...
    FL_EXPORT_C(fl_Double_Window, Fl_Double_Window_NewXY_WithLabel)(int x, int y, int w, int h, const char* title)
    {
        fl_Double_Window_Virtual_Funcs * funcs =
            Fl_Double_Window_default_virtual_funcs ();
        Fl_DerivedDouble_Window * window =
            new Fl_DerivedDouble_Window (x, y, w, h, title, funcs);
        return (fl_Double_Window)window;
    }
    FL_EXPORT_C(fl_Double_Window, Fl_Double_Window_NewXY)(int x, int y, int w, int h)
    {
        fl_Double_Window_Virtual_Funcs * funcs =
            Fl_Double_Window_default_virtual_funcs ();
        Fl_DerivedDouble_Window * window =
            new Fl_DerivedDouble_Window (x, y, w, h, 0, funcs);
        return (fl_Double_Window)window;
    }
    ...
    {
        Fl_Double_Window::default_callback (
            (static_cast<Fl_DerivedDouble_Window *> (win)), v);
    }
