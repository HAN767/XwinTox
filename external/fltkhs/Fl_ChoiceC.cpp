...
EXPORT
{
    ...
    {
        return (fl_Gl_Window) (static_cast<Fl_Choice *> (choice))
            ->as_gl_window ();
    }
    ...
    FL_EXPORT_C (void *, Fl_Choice_user_data) (fl_Choice choice)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Choice *> (choice))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (fl_Menu_Item) (static_cast<Fl_Choice *> (choice))
