...
EXPORT
{
    ...
    FL_EXPORT_C (void *, Fl_Round_Clock_user_data) (fl_Round_Clock b)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Round_Clock *> (b))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (static_cast<Fl_Round_Clock *> (b))
    ...
    {
        return (fl_Window) (static_cast<Fl_Round_Clock *> (round_clock))
            ->window ();
    }
    ...
    {
        return (fl_Group) (static_cast<Fl_Round_Clock *> (round_clock))
            ->as_group ();
    }
    FL_EXPORT_C(fl_Gl_Window,Fl_Round_Clock_as_gl_window)(fl_Round_Clock round_clock)
    {
        return (fl_Gl_Window) (static_cast<Fl_Round_Clock *> (round_clock))
            ->as_gl_window ();
    }
