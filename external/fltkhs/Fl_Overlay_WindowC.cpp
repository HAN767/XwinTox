...
Fl_DerivedOverlay_Window::Fl_DerivedOverlay_Window (
    ...
    : Fl_Overlay_Window (X, Y, W, H, l)
{
    this->draw_overlay_fp = draw_overlay_fp;
}
Fl_DerivedOverlay_Window::Fl_DerivedOverlay_Window (
    int X, int Y, int W, int H, void (*draw_overlay_fp) (fl_Overlay_Window))
    : Fl_Overlay_Window (X, Y, W, H, 0)
{
    this->draw_overlay_fp = draw_overlay_fp;
}
Fl_DerivedOverlay_Window::Fl_DerivedOverlay_Window (
    int W, int H, const char * l, void (*draw_overlay_fp) (fl_Overlay_Window))
    : Fl_Overlay_Window (W, H, l)
{
    this->draw_overlay_fp = draw_overlay_fp;
}
Fl_DerivedOverlay_Window::Fl_DerivedOverlay_Window (
    int W, int H, void (*draw_overlay_fp) (fl_Overlay_Window))
    : Fl_Overlay_Window (W, H, 0)
{
    this->draw_overlay_fp = draw_overlay_fp;
}
...
EXPORT
{
    ...
    {
        return (fl_Group) (static_cast<Fl_DerivedOverlay_Window *> (win))
            ->parent ();
    }
    FL_EXPORT_C(void,Fl_Overlay_Window_set_parent)(fl_Overlay_Window win,fl_Group grp)
    {
        (static_cast<Fl_DerivedOverlay_Window *> (win))
    ...
    {
        (static_cast<Fl_DerivedOverlay_Window *> (double_window))
            ->align (alignment);
    }
    ...
    {
        return (static_cast<Fl_DerivedOverlay_Window *> (win))
            ->selection_color ();
    }
    ...
    {
        Fl_Overlay_Window * castedWindow =
            (static_cast<Fl_DerivedOverlay_Window *> (win));
    ...
    FL_EXPORT_C (void *, Fl_Overlay_Window_user_data) (fl_Overlay_Window win)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_DerivedOverlay_Window *> (win))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (fl_Window) (static_cast<Fl_DerivedOverlay_Window *> (win))
            ->as_window ();
    }
    FL_EXPORT_C(fl_Gl_Window,Fl_Overlay_Window_as_gl_window)(fl_Overlay_Window win)
    {
        return (fl_Gl_Window) (static_cast<Fl_DerivedOverlay_Window *> (win))
            ->as_gl_window ();
    }
    ...
    {
        return (fl_Widget) (static_cast<Fl_DerivedOverlay_Window *> (win))
            ->resizable ();
    }
    ...
    {
        (static_cast<Fl_DerivedOverlay_Window *> (self))
    ...
    {
        return (fl_Widget *)(static_cast<Fl_DerivedOverlay_Window *> (self))
            ->array ();
    }
    ...
    {
        Fl_Overlay_Window::default_callback (
            (static_cast<Fl_DerivedOverlay_Window *> (win)), v);
    }
    ...
    {
        Fl_DerivedOverlay_Window * window =
            new Fl_DerivedOverlay_Window (w, h, title, draw_overlay_fp);
    ...
    {
        Fl_DerivedOverlay_Window * window =
            new Fl_DerivedOverlay_Window (w, h, 0, draw_overlay_fp);
