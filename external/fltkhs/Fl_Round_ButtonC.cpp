...
EXPORT
{
    ...
    FL_EXPORT_C (void *, Fl_Round_Button_user_data) (fl_Round_Button b)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Round_Button *> (b))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (static_cast<Fl_Round_Button *> (b))
    ...
    {
        return (fl_Window) (static_cast<Fl_Round_Button *> (round_button))
            ->window ();
    }
    ...
    {
        return (fl_Group) (static_cast<Fl_Round_Button *> (round_button))
            ->as_group ();
    }
    FL_EXPORT_C(fl_Gl_Window,Fl_Round_Button_as_gl_window)(fl_Round_Button round_button)
    {
        return (fl_Gl_Window) (static_cast<Fl_Round_Button *> (round_button))
            ->as_gl_window ();
    }
