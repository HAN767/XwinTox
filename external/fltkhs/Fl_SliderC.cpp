...
EXPORT
{
    ...
    {
        return (fl_Gl_Window) (static_cast<Fl_Slider *> (slider))
            ->Fl_Slider::as_gl_window ();
    }
    ...
    FL_EXPORT_C (void *, Fl_Slider_user_data) (fl_Slider slider)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Slider *> (slider))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (fl_Window) (static_cast<Fl_Slider *> (slider))
    ...
    FL_EXPORT_C(fl_Hor_Nice_Slider, Fl_Hor_Nice_Slider_New_WithLabel)(int x, int y, int w, int h, const char* label)
    {
        Fl_Hor_Nice_Slider * slider =
            new Fl_Hor_Nice_Slider (x, y, w, h, label);
    ...
    {
        Fl_Hor_Fill_Slider * slider =
            new Fl_Hor_Fill_Slider (x, y, w, h, label);
