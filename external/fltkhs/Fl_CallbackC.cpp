...
C_to_Fl_Callback::C_to_Fl_Callback (fl_Text_Buffer_Callback * callback,
                                    void * invoker)
{
...
void * C_to_Fl_Callback::get_user_data () { return this->user_data; }
void C_to_Fl_Callback::set_user_data (void * user_data)
{
    this->user_data = user_data;
}
int C_to_Fl_Callback::menu_insert (Fl_Menu_Item * item, int index, char * name,
                                   int shortcut, int flags)
{
    if (this->callback)
    {
...
int C_to_Fl_Callback::menu_insert (Fl_Menu_ * menu_, int index, char * name,
                                   int shortcut, int flags)
{
    if (this->callback)
    {
...
int C_to_Fl_Callback::menu_add (Fl_Menu_Item * item, char * name, int shortcut,
                                int flags)
{
    if (this->callback)
    {
...
int C_to_Fl_Callback::menu_add (Fl_Menu_Item * item, char * name,
                                char * shortcut, int flags)
{
    if (this->callback)
    {
...
int C_to_Fl_Callback::menu_add (Fl_Menu_ * menu_, char * name, char * shortcut,
                                int flags)
{
    if (this->callback)
    {
...
int C_to_Fl_Callback::menu_add (Fl_Menu_ * menu_, char * name, int shortcut,
                                int flags)
{
    if (this->callback)
    {
...
void C_to_Fl_Callback::runCallback () { (*text_buffer_callback) (user_data); }
