...
EXPORT
{
    ...
    FL_EXPORT_C (void *, Fl_Menu_Button_user_data) (fl_Menu_Button menu_button)
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Menu_Button *> (menu_button))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        C_to_Fl_Callback * stored_cb = (static_cast<C_to_Fl_Callback *> (
            (static_cast<Fl_Menu_Item *> (menu_button))->user_data ()));
        if (stored_cb)
        {
    ...
    {
        return (fl_Menu_Item) (static_cast<Fl_Menu_Button *> (menu_button))
    ...
    FL_EXPORT_C(int,Fl_Menu_Button_insert)(fl_Menu_Button menu_button,int index,char* name,int shortcut,fl_Callback* cb)
    {
        ...
        return callback_interceptor->menu_insert (
            (static_cast<Fl_Menu_Button *> (menu_button)), index, name,
            shortcut, 0);
    }
    ...
    FL_EXPORT_C(int,Fl_Menu_Button_add)(fl_Menu_Button menu_button,char* name,int shortcut,fl_Callback* cb)
    {
        ...
        return callback_interceptor->menu_add (
            (static_cast<Fl_Menu_Button *> (menu_button)), name, shortcut, 0);
    }
    ...
    FL_EXPORT_C(int,Fl_Menu_Button_add_with_flags)(fl_Menu_Button menu_button,char* name,int shortcut,fl_Callback* cb,int flags)
    {
        C_to_Fl_Callback * callback_interceptor = new C_to_Fl_Callback (cb);
        return callback_interceptor->menu_add (
            (static_cast<Fl_Menu_Button *> (menu_button)), name, shortcut,
            flags);
    }
